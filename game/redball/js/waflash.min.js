var Module = (() => {
  ...
  return function (r) {
    var t, n;
    ((r = void 0 !== (r = r || {}) ? r : {}).ready = new Promise(function (
      e,
      r
    ) {
      (t = e), (n = r);
          ...
          !(function (e) {
            ...
            function l() {
              ...
              n.prototype = {
                ...
                open: function (e, t) {
                  (this.name = t),
                    ...
                    r.addRunDependency("fp " + this.name);
                },
                send: function () {},
                onload: function () {
              ...
              for (var o = e.files, a = 0; a < o.length; ++a)
                new n(o[a].start, o[a].end, o[a].audio || 0).open(
                  "GET",
                  o[a].filename
                );
              function i(o) {
            ...
            f ||
              ...
              (s.onprogress = function (e) {
                ...
                if ((e.total && (n = e.total), e.loaded)) {
                  ...
                  (o = Math.ceil((o * r.expectedDataFileDownloads) / c)),
                    r.setStatus &&
                      r.setStatus("Downloading data... (" + u + "/" + o + ")");
                } else
                  r.dataFileDownloads ||
                    (r.setStatus && r.setStatus("Downloading data..."));
              }),
              ...
              r.calledRun
                ? l()
                : (r.preRun || (r.preRun = []), r.preRun.push(l));
          })({
            files: [
    ...
    se((oe = "waflash.wasm")) ||
      ((ae = oe), (oe = r.locateFile ? r.locateFile(ae, d) : d + ae));
    var fe = {
      993777: function (e) {
        const r = N(e);
      ...
      998474: function (e, t, n, o) {
        var a = r.SDL2,
          i = function (r) {
            void 0 !== a.capture.silenceTimer &&
              (clearTimeout(a.capture.silenceTimer),
              (a.capture.silenceTimer = void 0)),
              (a.capture.mediaStreamNode =
                a.audioContext.createMediaStreamSource(r)),
              (a.capture.scriptProcessorNode =
                a.audioContext.createScriptProcessor(t, e, 1)),
          ...
          u = function (e) {};
        (a.capture.silenceBuffer = a.audioContext.createBuffer(
          e,
          t,
        ...
        (a.capture.silenceTimer = setTimeout(function () {
          (a.capture.currentCaptureBuffer = a.capture.silenceBuffer),
            ge("vi", n, [o]);
      ...
      1000126: function (e, t, n, o) {
        var a = r.SDL2;
        (a.audio.scriptProcessorNode = a.audioContext.createScriptProcessor(
          t,
          0,
          e
        )),
          (a.audio.scriptProcessorNode.onaudioprocess = function (e) {
            void 0 !== a &&
              void 0 !== a.audio &&
              ((a.audio.currentOutputBuffer = e.outputBuffer),
              ge("vi", n, [o]));
          }),
      ...
      1000536: function (e, t) {
        for (
          var n = r.SDL2,
            o = n.capture.currentCaptureBuffer.numberOfChannels,
            a = 0;
          a < o;
          ++a
        ) {
      ...
      1001141: function (e, t) {
        for (
          var n = r.SDL2,
            o = n.audio.currentOutputBuffer.numberOfChannels,
            a = 0;
          a < o;
          ++a
        ) {
        ...
        if (e) {
          if (
            (void 0 !== t.capture.silenceTimer &&
              clearTimeout(t.capture.silenceTimer),
            void 0 !== t.capture.stream)
          ) {
            for (
              var n = t.capture.stream.getAudioTracks(), o = 0;
              o < n.length;
              o++
            )
          ...
          void 0 !== t.capture.scriptProcessorNode &&
            ...
            void 0 !== t.capture.mediaStreamNode &&
              ...
              (t.capture.mediaStreamNode = void 0)),
            void 0 !== t.capture.silenceBuffer &&
              (t.capture.silenceBuffer = void 0),
            (t.capture = void 0);
        } else
          null != t.audio.scriptProcessorNode &&
            (t.audio.scriptProcessorNode.disconnect(),
            (t.audio.scriptProcessorNode = void 0)),
            (t.audio = void 0);
      ...
      1002793: function (e, t, n) {
        ...
        u.ctxCanvas !== r.canvas &&
          ((u.ctx = r.createContext(r.canvas, !1, !0)),
          (u.ctxCanvas = r.canvas)),
          (u.w === o && u.h === a && u.imageCtx === u.ctx) ||
            ((u.image = u.ctx.createImageData(o, a)),
            (u.w = o),
            (u.h = a),
            (u.imageCtx = u.ctx));
        var s,
    ...
    function ve(e) {
      var r = pe[e];
      return (
        r || (e >= pe.length && (pe.length = e + 1), (pe[e] = r = Q.get(e))), r
      );
    }
    function ge(e, t, n) {
      return e.includes("j")
        ...
        return (
          Le.isDir(o.mode)
            ...
            ? ((o.node_ops = Ce.ops_table.file.node),
              ...
              (o.contents = null))
            : Le.isLink(o.mode)
            ? ((o.node_ops = Ce.ops_table.link.node),
              (o.stream_ops = Ce.ops_table.link.stream))
            : Le.isChrdev(o.mode) &&
      ...
      stream_ops: {
        ...
        write: function (e, r, t, n, o, a) {
          ...
          if (
            ...
            if (a)
              return (i.contents = r.subarray(t, t + n)), (i.usedBytes = n), n;
          ...
          if (
            (Ce.expandFileStorage(i, o + n), i.contents.subarray && r.subarray)
          )
    ...
    var Se,
      Ae = {
        ...
        getDB: (e, r) => {
          ...
          (t.onupgradeneeded = (e) => {
            ...
            (r = t.objectStoreNames.contains(Ae.DB_STORE_NAME)
              ...
              : t.createObjectStore(Ae.DB_STORE_NAME)).indexNames.contains(
              "timestamp"
        ...
        getLocalSet: (e, r) => {
          ...
          for (
            var a = Le.readdir(e.mountpoint).filter(n).map(o(e.mountpoint));
            a.length;
            ...
            Le.isDir(i.mode) &&
              a.push.apply(a, Le.readdir(u).filter(n).map(o(u))),
        ...
        reconcile: (e, r, t) => {
          ...
          if (
            ...
            return t(null);
          var i = !1,
            u = ("remote" === e.type ? e.db : r.db).transaction(
              [Ae.DB_STORE_NAME],
              "readwrite"
            ),
          ...
          (u.onerror = (e) => {
            ...
            a
              ...
              .forEach((e) => {
                "local" === r.type
                  ? Ae.removeLocalEntry(e, c)
                  : Ae.removeRemoteEntry(s, e, c);
              });
        },
      },
      Le = {
        ...
        lookupNode: (e, r) => {
          ...
          for (
            var n = Le.hashName(e.id, r), o = Le.nameTable[n];
            o;
            o = o.name_next
          ) {
            var a = o.name;
        ...
        mayOpen: (e, r) =>
          e
            ? Le.isLink(e.mode)
              ? 32
              : Le.isDir(e.mode) &&
                ("r" !== Le.flagsToPermissionString(r) || 512 & r)
              ? 31
        ...
        mount: (e, r, t) => {
          ...
          if (!o && !a) {
            ...
            if (((t = i.path), (n = i.node), Le.isMountpoint(n)))
              throw new Le.ErrnoError(10);
        ...
        mkdev: (e, r, t) => (
          void 0 === t && ((t = r), (r = 438)), (r |= 8192), Le.mknod(e, r, t)
        ),
        symlink: (e, r) => {
        ...
        rename: (e, r) => {
          ...
          if ("." !== (f = xe.relative(r, o)).charAt(0))
            throw new Le.ErrnoError(55);
          try {
            s = Le.lookupNode(n, u);
          } catch (e) {}
          if (c !== s) {
            ...
            if ((d = s ? Le.mayDelete(n, u, l) : Le.mayCreate(n, u)))
              throw new Le.ErrnoError(d);
            if (!t.node_ops.rename) throw new Le.ErrnoError(63);
            if (Le.isMountpoint(c) || (s && Le.isMountpoint(s)))
              throw new Le.ErrnoError(10);
            if (n !== t && (d = Le.nodePermissions(t, "w")))
              throw new Le.ErrnoError(d);
            Le.hashRemoveNode(c);
            try {
        ...
        chmod: (e, r, t) => {
          var n;
          "string" == typeof e
            ? (n = Le.lookupPath(e, { follow: !t }).node)
            : (n = e);
        ...
        chown: (e, r, t, n) => {
          var o;
          "string" == typeof e
            ? (o = Le.lookupPath(e, { follow: !n }).node)
            : (o = e);
        ...
        truncate: (e, r) => {
          ...
          var t;
          "string" == typeof e
            ? (t = Le.lookupPath(e, { follow: !0 }).node)
            : (t = e);
        ...
        open: (e, t, n, o, a) => {
          ...
          if (
            (Le.isChrdev(i.mode) && (t &= -513), 65536 & t && !Le.isDir(i.mode))
          )
          ...
          return (
            ...
            !r.logReadFiles ||
              1 & t ||
              (Le.readFiles || (Le.readFiles = {}),
              e in Le.readFiles || (Le.readFiles[e] = 1)),
            c
          );
        },
        close: (e) => {
        ...
        createDefaultDevices: () => {
          Le.mkdir("/dev"),
            Le.registerDevice(Le.makedev(1, 3), {
              read: () => 0,
              write: (e, r, t, n, o) => n,
            }),
        ...
        createStandardStreams: () => {
          ...
          Le.open("/dev/stdin", 0),
            Le.open("/dev/stdout", 1),
            Le.open("/dev/stderr", 1);
        },
        ensureErrnoError: () => {
          Le.ErrnoError ||
          ...
          if (
            ...
            (a.prototype.cacheLength = function () {
              ...
              var r,
                ...
                a =
                  (r = e.getResponseHeader("Content-Encoding")) && "gzip" === r,
                i = 1048576;
              o || (i = n);
              var u = this;
              u.setDataGetter((e) => {
        ...
        createPreloadedFile: (e, r, t, n, o, i, u, s, c, f) => {
          ...
          function d(t) {
            function a(t) {
              f && f(),
                s || Le.createDataFile(e, r, t, n, o, c),
                i && i(),
                te();
            }
        ...
        doStat: function (e, r, t) {
          try {
            ...
            if (
              e &&
              e.node &&
              we.normalize(r) !== we.normalize(Le.getPath(e.node))
            )
              return -54;
            throw e;
          }
          return (
            ...
            (ue = [
              ...
              +Math.abs(ie) >= 1
                ? ie > 0
                  ? (0 | Math.min(+Math.floor(ie / 4294967296), 4294967295)) >>>
                    0
                  : ~~+Math.ceil((ie - +(~~ie >>> 0)) / 4294967296) >>> 0
                : 0),
            ]),
    ...
    function _e(e, r) {
      if (
        ((Ie.mainLoop.timingMode = e),
        (Ie.mainLoop.timingValue = r),
        !Ie.mainLoop.func)
      )
        return 1;
            ...
            if (Ie.mainLoop.queue.length > 0) {
              ...
              if ((t.func(t.arg), Ie.mainLoop.remainingBlockers)) {
                ...
                t.counted
                  ...
                  : ((o += 0.5),
                    (Ie.mainLoop.remainingBlockers = (8 * n + o) / 9));
              }
              if (
                (m(
                  'main loop blocker "' +
              ...
              i() &&
                ((Ie.mainLoop.currentFrameNumber =
                  (Ie.mainLoop.currentFrameNumber + 1) | 0),
                ...
                Ie.mainLoop.currentFrameNumber % Ie.mainLoop.timingValue != 0
                  ...
                  : (0 == Ie.mainLoop.timingMode &&
                      (Ie.mainLoop.tickStartTime = Se()),
    ...
    var Ie = {
          ...
          if ((r.preloadPlugins || (r.preloadPlugins = []), !Ie.initted)) {
            ...
            var e = {
              ...
              handle: function (e, t, n, o) {
                ...
                if (Ie.hasBlobConstructor)
                  try {
                    (a = new Blob([e], { type: Ie.getMimetype(t) })).size !==
                      e.length &&
                      (a = new Blob([new Uint8Array(e).buffer], {
            ...
            var t = {
              ...
              handle: function (e, t, n, o) {
                ...
                function u() {
                  a ||
                    ((a = !0), (r.preloadedAudios[t] = new Audio()), o && o());
                }
        ...
        createContext: function (e, t, n, o) {
          ...
          if (t) {
            ...
            void 0 !== Oe &&
              (i = Oe.createContext(e, u)) &&
              (a = Oe.getContext(i).GLctx);
          ...
          function o() {
            ...
            (document.fullscreenElement ||
              ...
              ? ((n.exitFullscreen = Ie.exitFullscreen),
                ...
                (Ie.isFullscreen = !0),
                Ie.resizeCanvas
                  ? Ie.setFullscreenCanvasSize()
                  : Ie.updateCanvasDimensions(n))
              : (e.parentNode.insertBefore(n, e),
                e.parentNode.removeChild(e),
                Ie.resizeCanvas
                  ? Ie.setWindowedCanvasSize()
                  : Ie.updateCanvasDimensions(n)),
          ...
          if (Ie.pointerLock)
            "mousemove" != e.type && "mozMovementX" in e
              ...
              "undefined" != typeof SDL
                ...
                : ((Ie.mouseX += Ie.mouseMovementX),
                  (Ie.mouseY += Ie.mouseMovementY));
          else {
            ...
            if (
              ...
              if ("touchstart" === e.type)
                (Ie.lastTouches[u.identifier] = f),
                  (Ie.touches[u.identifier] = f);
              else if ("touchend" === e.type || "touchmove" === e.type) {
                var l = Ie.touches[u.identifier];
                l || (l = f),
                  (Ie.lastTouches[u.identifier] = l),
                  (Ie.touches[u.identifier] = f);
              }
              return;
            }
      ...
      Re = {
          ...
          if (
            ...
            for (var u = t + r, s = 0; n < u; ) {
              ...
              if (0 === c.length) {
                ...
                var f;
                ((f = e.context.audioCtx.createBufferSource()).buffer =
                  c.audioBuf),
                  (f.playbackRate.value = e.playbackRate),
                  (c.audioBuf._loopStart || c.audioBuf._loopEnd) &&
                    ((f.loopStart = c.audioBuf._loopStart),
                    (f.loopEnd = c.audioBuf._loopEnd));
                var l = 0;
        ...
        updateSourceTime: function (e) {
          ...
          if (e.bufsProcessed >= e.bufQueue.length && !e.looping)
            ...
            if (4136 !== e.type && e.looping) {
              ...
              u > 0 &&
                (e.bufStartTime += Math.floor((r - e.bufStartTime) / u) * u);
            }
            for (var s = 0; s < e.bufQueue.length; s++) {
              ...
              if ((c = e.bufQueue[e.bufsProcessed]).length > 0) {
                if (
                  r <
                  (t = e.bufStartTime + c.audioBuf.duration / e.playbackRate)
                ) {
        ...
        setSourceState: function (e, r) {
          4114 === r
            ...
            : 4115 === r
            ? 4114 === e.state &&
              (Re.updateSourceTime(e), Re.stopSourceAudio(e), (e.state = 4115))
            : 4116 === r
            ? 4113 !== e.state &&
              ((e.state = 4116),
              (e.bufsProcessed = e.bufQueue.length),
        ...
        sourceSeek: function (e, r) {
          var t = 4114 == e.state;
          if (
            (t && Re.setSourceState(e, 4113),
            null !== e.bufQueue[e.bufsProcessed].audioBuf)
          ) {
            for (
              e.bufsProcessed = 0;
              r > e.bufQueue[e.bufsProcessed].audioBuf.duration;
          ...
          if (Re.currentCtx)
            switch (r) {
              case 49152:
                ...
                (Re.currentCtx.dopplerFactor = t),
                  Re.updateListenerSpace(Re.currentCtx);
                break;
              case 49155:
                if (!Number.isFinite(t) || t <= 0)
                  return void (Re.currentCtx.err = 40963);
                (Re.currentCtx.speedOfSound = t),
                  Re.updateListenerSpace(Re.currentCtx);
                break;
              case 53248:
                switch (t) {
        ...
        getListenerParam: function (e, r) {
          ...
          switch (r) {
            ...
            case 4111:
              return Re.currentCtx.listener.direction.concat(
                Re.currentCtx.listener.up
              );
            case 4106:
        ...
        getSourceParam: function (e, r, t) {
          ...
          switch (t) {
            ...
            case 4133:
              return (
                (o = Re.sourceTell(n)) > 0 && (o *= n.bufQueue[0].frequency), o
              );
            case 4134:
              var o;
              return (
            ...
            case 8201:
              ...
              return a * i;
            case 8202:
              for (a = 0, u = 0; u < n.bufQueue.length; u++)
                a += n.bufQueue[u].length;
              return a;
            case 8203:
                ...
                switch (t) {
                  ...
                  case 4097:
                    if (!Number.isFinite(n))
                      return void (Re.currentCtx.err = 40963);
                    (o.coneInnerAngle = n),
                      o.panner && (o.panner.coneInnerAngle = n % 360);
                    break;
                  case 4098:
                    if (!Number.isFinite(n))
                      return void (Re.currentCtx.err = 40963);
                    (o.coneOuterAngle = n),
                      o.panner && (o.panner.coneOuterAngle = n % 360);
                    break;
                  case 4099:
                  ...
                  case 4103:
                    if (1 === n) {
                      ...
                      4136 === o.type &&
                        ...
                        (a._duration =
                          o.bufQueue[0].audioBuf.duration / o.playbackRate),
                  ...
                  case 4105:
                    ...
                    if (0 === n) {
                      for (var u = 0; u < o.bufQueue.length; u++)
                        o.bufQueue[u].refCount--;
                      (o.bufQueue.length = 1),
                  ...
                  case 4129:
                    if (!Number.isFinite(n) || n < 0)
                      return void (Re.currentCtx.err = 40963);
                    (o.rolloffFactor = n),
                      o.panner && (o.panner.rolloffFactor = n);
                    break;
                  case 4130:
                    if (!Number.isFinite(n) || n < 0 || n > 1)
                      return void (Re.currentCtx.err = 40963);
                    (o.coneOuterGain = n),
                      o.panner && (o.panner.coneOuterGain = n);
                    break;
                  case 4131:
                    if (!Number.isFinite(n) || n < 0)
                      return void (Re.currentCtx.err = 40963);
    ...
    var Oe = {
      ...
      generateTempBuffers: function (e, r) {
        ...
        (r.tempVertexBufferCounters1 = []),
          ...
          (r.tempVertexBufferCounters1.length =
            r.tempVertexBufferCounters2.length =
              t + 1),
        ...
        for (var n = 0; n <= t; ++n) {
          (r.tempIndexBuffers[n] = null),
            (r.tempVertexBufferCounters1[n] = r.tempVertexBufferCounters2[n] =
              0);
        ...
        if (e) {
          ...
          for (
            var s = Oe.MAX_TEMP_BUFFER_SIZE >> 1,
              c = new Uint16Array(s),
              f = ((n = 0), 0);
            !((c[n++] = f),
            n >= s ||
      ...
      newRenderingFrameStarted: function () {
        if (Oe.currentContext) {
          ...
          (Oe.currentContext.tempVertexBuffers1 =
            Oe.currentContext.tempVertexBuffers2),
          ...
          for (
            var r = Oe.log2ceilLookup(Oe.MAX_TEMP_BUFFER_SIZE), t = 0;
            t <= r;
            ++t
          )
      ...
      calcBufLength: function (e, r, t, n) {
        return t > 0
          ? n * t
          : e * Oe.byteSizeByType[r - Oe.byteSizeByTypeRoot] * n;
      },
      usedTempBuffers: [],
        ...
        for (var r = 0; r < Oe.currentContext.maxVertexAttribs; ++r) {
          ...
          if (t.clientside && t.enabled) {
            ...
            qr.bindBuffer(34962, o),
              ...
              t.vertexAttribPointerAdaptor.call(
                qr,
                r,
                t.size,
                t.type,
      ...
      postDrawHandleClientVertexAttribBindings: function () {
        Oe.resetBufferBinding &&
          qr.bindBuffer(34962, Oe.buffers[qr.currentArrayBufferBinding]);
      },
        ...
        if (!e.getContextSafariWebGL2Fixed) {
          (e.getContextSafariWebGL2Fixed = e.getContext),
            (e.getContext = function (r, t) {
              ...
              return ("webgl" == r) == n instanceof WebGLRenderingContext
                ? n
                : null;
            });
        }
      ...
      deleteContext: function (e) {
        Oe.currentContext === Oe.contexts[e] && (Oe.currentContext = null),
          "object" == typeof ze &&
            ze.removeAllHandlersOnTarget(Oe.contexts[e].GLctx.canvas),
          Oe.contexts[e] &&
    ...
    var ze = {
        ...
        removeAllEventListeners: function () {
          for (var e = ze.eventHandlers.length - 1; e >= 0; --e)
            ze._removeHandler(e);
          (ze.eventHandlers = []), (ze.deferredCalls = []);
        },
        registerRemoveEventListeners: function () {
          ze.removeEventListenersRegistered ||
            (W.push(ze.removeAllEventListeners),
            (ze.removeEventListenersRegistered = !0));
        },
        deferredCalls: [],
        ...
        removeDeferredCalls: function (e) {
          for (var r = 0; r < ze.deferredCalls.length; ++r)
            ze.deferredCalls[r].targetFunction == e &&
              (ze.deferredCalls.splice(r, 1), --r);
        },
        canPerformEventHandlerRequests: function () {
          return (
            ze.inEventHandler && ze.currentEventHandler.allowsDeferredCalls
          );
        },
          ...
          function w() {
            document.fullscreenElement ||
              ...
              je.canvasResizedCallback &&
                ve(je.canvasResizedCallback)(
                  37,
                  0,
                  je.canvasResizedCallbackUserData
                ));
          }
          return (
    ...
    function Ze(e, r) {
      if (
        ((0 == r.scaleMode && 0 == r.canvasResolutionScaleMode) || $e(e, r),
        e.requestFullscreen)
      )
        e.requestFullscreen();
      else {
    ...
    function ir(e, r, t, n) {
      for (var o = 0; o < e; o++) {
        var a = qr[t](),
          i = a && Oe.getNewId(n);
        a ? ((a.name = i), (n[i] = a)) : Oe.recordError(1282),
          (P[(r + 4 * o) >> 2] = i);
      }
    }
        ...
        return (
          "number" == typeof t &&
            (r.uniformLocsById[e] = t =
              qr.getUniformLocation(
                r,
                r.uniformArrayNamesById[e] + (t > 0 ? "[" + t + "]" : "")
              )),
          t
        );
      }
      ...
      24 & e &&
        ...
        (r +=
          ...
          (function (e) {
            ...
            var a = null;
            if (128 & e)
              for (a = Sr(arguments); a[1].includes("_emscripten_"); )
                a = Sr(a[0]);
            var i = r.split("\n");
            r = "";
            ...
            for (var f in i) {
              var l = i[f],
                ...
                h = c.exec(l);
              if (h && 5 == h.length)
                (d = h[1]), (m = h[2]), (p = h[3]), (g = h[4]);
              else {
                if (
                  ((h = u.exec(l)) || (h = s.exec(l)), !(h && h.length >= 4))
                ) {
                  r += l + "\n";
                  continue;
                }
    ...
    function Tr(e, r, t, n, o, a, i) {
      ...
      var u = {
        ...
        handlerFunc: function (t) {
          var a = t || event;
          Fr(ze.mouseEvent, a, e),
            ve(n)(o, ze.mouseEvent, r) && a.preventDefault();
        },
        useCapture: t,
      };
      ze.registerOrRemoveHandler(u);
    ...
    function Mr(e, r, t, n, o, a, i) {
      ...
      var u = {
        ...
        handlerFunc: function (e) {
          ...
          (t = u),
            (a = ["hidden", "visible", "prerender", "unloaded"].indexOf(
    ...
    var Kr,
      $r = {
        ...
        kc: function (e, r, t, n) {
          try {
            ...
            return (
              (n &= -4353),
              (r = Be.calculateAt(e, r, a)),
              Be.doStat(o ? Le.lstat : Le.stat, r, t)
            );
          } catch (e) {
            if (void 0 === Le || !(e instanceof Le.ErrnoError)) throw e;
            return -e.errno;
        ...
        rc: function (e, r) {
          ...
          (P[(r + 28) >> 2] = o),
            (P[(r + 36) >> 2] = -60 * t.getTimezoneOffset());
                ...
                try {
                  switch (r) {
                    case 4352:
                      if (n > 0)
                        for (
                          var u = (i = Re.currentCtx.audioCtx.createBuffer(
                              1,
                              n,
                              o
                            )).getChannelData(0),
                    ...
                    case 4353:
                      if (n > 0) {
                        u = (i = Re.currentCtx.audioCtx.createBuffer(
                          1,
                          n >> 1,
                          o
                        )).getChannelData(0);
        ...
        $b: function (e, r) {
          if (Re.currentCtx) {
            for (var t = 0; t < e; ++t) {
              var n = P[(r + 4 * t) >> 2];
              if (!Re.currentCtx.sources[n])
                return void (Re.currentCtx.err = 40961);
            }
            for (t = 0; t < e; ++t) {
              n = P[(r + 4 * t) >> 2];
        ...
        Vb: function (e, r, t) {
          if (Re.currentCtx) {
            ...
            if (n) {
              if (
                r >
                (1 === n.bufQueue.length && 0 === n.bufQueue[0].id
                  ? 0
                  : n.bufsProcessed)
              )
        ...
        Zb: function (e) {
          var r = Re.contexts[e];
          Re.currentCtx !== r
            ? (Re.contexts[e].interval &&
                clearInterval(Re.contexts[e].interval),
        ...
        eb: function (e) {
          return 0 === e
            ? ((Re.currentCtx = null), 0)
            : ((Re.currentCtx = Re.contexts[e]), 1);
        },
        Gc: function (e) {
        ...
        Z: function (e, r) {
          ...
          return (
            (P[r >> 2] = (t / 1e3) | 0),
            (P[(r + 4) >> 2] = ((t % 1e3) * 1e3 * 1e3) | 0),
            0
          );
        },
        ai: function (e) {
          return 12448 == e
            ? (Ne.setErrorCode(12288), 1)
            : (Ne.setErrorCode(12300), 0);
        },
        ...
        Rh: function (e, r) {
          if (62e3 != e) return Ne.setErrorCode(12296), 0;
          if ((Ne.setErrorCode(12288), Ne.stringCache[r]))
            return Ne.stringCache[r];
          var t;
          switch (r) {
            case 12371:
              t = j("Emscripten");
        ...
        Ph: function () {
          if ((ze.removeDeferredCalls(Je), document.exitPointerLock))
            document.exitPointerLock();
          else {
        ...
        Og: function (e, r) {
          for (var t = 0; t < e; t++) {
            ...
            o &&
              ...
              (o.name = 0),
              (Oe.buffers[n] = null),
              n == qr.currentArrayBufferBinding &&
                (qr.currentArrayBufferBinding = 0),
              n == qr.currentElementArrayBufferBinding &&
                (qr.currentElementArrayBufferBinding = 0),
              n == qr.currentPixelPackBufferBinding &&
                (qr.currentPixelPackBufferBinding = 0),
              n == qr.currentPixelUnpackBufferBinding &&
                (qr.currentPixelUnpackBufferBinding = 0));
          }
        },
        Ng: function (e, r) {
          for (var t = 0; t < e; ++t) {
            var n = P[(r + 4 * t) >> 2],
              o = Oe.framebuffers[n];
            o &&
              (qr.deleteFramebuffer(o),
              (o.name = 0),
              (Oe.framebuffers[n] = null));
          }
        },
        Mg: function (e) {
          if (e) {
            var r = Oe.programs[e];
            r
              ? (qr.deleteProgram(r), (r.name = 0), (Oe.programs[e] = null))
              : Oe.recordError(1281);
          }
        },
        qe: function (e, r) {
        ...
        Ih: function (e, r) {
          for (var t = 0; t < e; t++) {
            var n = P[(r + 4 * t) >> 2],
              o = Oe.queries[n];
            o &&
              (qr.disjointTimerQueryExt.deleteQueryEXT(o),
              (Oe.queries[n] = null));
          }
        },
        Lg: function (e, r) {
          for (var t = 0; t < e; t++) {
            ...
            o &&
              (qr.deleteRenderbuffer(o),
              (o.name = 0),
              (Oe.renderbuffers[n] = null));
          }
        },
        $c: function (e, r) {
          for (var t = 0; t < e; t++) {
        ...
        Kg: function (e) {
          if (e) {
            var r = Oe.shaders[e];
            r
              ? (qr.deleteShader(r), (Oe.shaders[e] = null))
              : Oe.recordError(1281);
          }
        },
        id: function (e) {
          if (e) {
            var r = Oe.syncs[e];
            r
              ? (qr.deleteSync(r), (r.name = 0), (Oe.syncs[e] = null))
              : Oe.recordError(1281);
          }
        },
        Jg: function (e, r) {
        ...
        Pc: function (e, r) {
          for (var t = 0; t < e; t++) {
            ...
            o &&
              (qr.deleteTransformFeedback(o),
              (o.name = 0),
              (Oe.transformFeedbacks[n] = null));
          }
        },
        $d: function (e, r) {
          for (var t = 0; t < e; t++) {
        ...
        Dg: function (e) {
          (Oe.currentContext.clientBuffers[e].enabled = !1),
            qr.disableVertexAttribArray(e);
        },
        Cg: function (e, r, t) {
        ...
        yg: function (e) {
          (Oe.currentContext.clientBuffers[e].enabled = !0),
            qr.enableVertexAttribArray(e);
        },
        ne: function (e) {
          qr.endQuery(e);
        },
        ...
        Dh: function (e, r, t) {
          t
            ? (P[t >> 2] = qr.disjointTimerQueryExt.getQueryEXT(e, r))
            : Oe.recordError(1281);
        },
        bg: function (e, r, t) {
          t
            ? (P[t >> 2] = qr.getRenderbufferParameter(e, r))
            : Oe.recordError(1281);
        },
        Tc: function (e, r, t) {
          t
            ? (T[t >> 2] = qr.getSamplerParameter(Oe.samplers[e], r))
            : Oe.recordError(1281);
        },
        Uc: function (e, r, t) {
          t
            ? (P[t >> 2] = qr.getSamplerParameter(Oe.samplers[e], r))
            : Oe.recordError(1281);
        },
        $f: function (e, r, t, n) {
        ...
        vd: function (e, r) {
          ...
          if (t)
            return r < 0 || r >= t.length ? (Oe.recordError(1281), 0) : t[r];
          switch (e) {
            case 7939:
        ...
        Sf: function (e, r) {
          if (((r = N(r)), (e = Oe.programs[e]))) {
            ...
            if (
              i &&
              n < i[0] &&
              (t[(n += i[1])] = t[n] || qr.getUniformLocation(e, r))
            )
              return n;
          } else Oe.recordError(1281);
          return -1;
        ...
        Af: function (e, r, t, n, o, a, i) {
          if (Oe.currentContext.version >= 2)
            if (qr.currentPixelPackBufferBinding)
              qr.readPixels(e, r, t, n, o, a, i);
            else {
              var u = br(a);
        ...
        mf: function (e, r, t, n, o, a, i, u, s) {
          if (Oe.currentContext.version >= 2)
            if (qr.currentPixelUnpackBufferBinding)
              qr.texImage2D(e, r, t, n, o, a, i, u, s);
            else if (s) {
              var c = br(u);
              qr.texImage2D(e, r, t, n, o, a, i, u, c, s >> yr(c));
            } else qr.texImage2D(e, r, t, n, o, a, i, u, null);
          else
            qr.texImage2D(e, r, t, n, o, a, i, u, s ? wr(u, i, n, o, s) : null);
        },
        we: function (e, r, t, n, o, a, i, u, s, c) {
          if (qr.currentPixelUnpackBufferBinding)
            qr.texImage3D(e, r, t, n, o, a, i, u, s, c);
          else if (c) {
            var f = br(s);
        ...
        gf: function (e, r, t, n, o, a, i, u, s) {
          if (Oe.currentContext.version >= 2)
            if (qr.currentPixelUnpackBufferBinding)
              qr.texSubImage2D(e, r, t, n, o, a, i, u, s);
            else if (s) {
              var c = br(u);
            ...
            var f = null;
            s && (f = wr(u, i, o, a, s)),
              qr.texSubImage2D(e, r, t, n, o, a, i, u, f);
          }
        },
        ve: function (e, r, t, n, o, a, i, u, s, c, f) {
          if (qr.currentPixelUnpackBufferBinding)
            qr.texSubImage3D(e, r, t, n, o, a, i, u, s, c, f);
          else if (f) {
            var l = br(c);
        ...
        ef: function (e, r, t) {
          if (Oe.currentContext.version >= 2)
            qr.uniform1fv(vr(e), T, t >> 2, r);
          else {
            if (r <= 288)
              for (var n = xr[r - 1], o = 0; o < r; ++o)
                n[o] = T[(t + 4 * o) >> 2];
        ...
        cf: function (e, r, t) {
          if (Oe.currentContext.version >= 2)
            qr.uniform1iv(vr(e), P, t >> 2, r);
          else {
            if (r <= 288)
              for (var n = Er[r - 1], o = 0; o < r; ++o)
                n[o] = P[(t + 4 * o) >> 2];
        ...
        Re: function (e, r, t, n) {
          if (Oe.currentContext.version >= 2)
            qr.uniformMatrix2fv(vr(e), !!t, T, n >> 2, 4 * r);
          else {
            if (r <= 72)
        ...
        Qe: function (e, r, t, n) {
          if (Oe.currentContext.version >= 2)
            qr.uniformMatrix3fv(vr(e), !!t, T, n >> 2, 9 * r);
          else {
            if (r <= 32)
        ...
        Pe: function (e, r, t, n) {
          if (Oe.currentContext.version >= 2)
            qr.uniformMatrix4fv(vr(e), !!t, T, n >> 2, 16 * r);
          else {
            if (r <= 18) {
              var o = xr[16 * r - 1],
                a = T;
              ...
              (function (e, r) {
                ...
                for (var a, i, u, s, c = []; ; ) {
                  ...
                  if (((i = L[(t + 1) >> 0]), 37 == a)) {
                    ...
                    switch (
                      (y < 0 && ((y = 6), (b = !1)), String.fromCharCode(i))
                    ) {
                      case "h":
                    ...
                    switch (
                      (h && t++, (i = L[(t + 1) >> 0]), String.fromCharCode(i))
                    ) {
                      case "d":
                      case "i":
                      case "u":
                      ...
                      case "p":
                        ...
                        if (100 == i || 105 == i) A = kr(u, 8 * h).toString(10);
                          ...
                          (A = Cr(u, 8 * h).toString(10)), (u = Math.abs(u));
                          ...
                          if (((k = m && 0 != u ? "0x" : ""), u < 0)) {
                            ...
                            for (A = C.join(""); A.length < 2 * h; )
                              A = "f" + A;
                          } else A = E.toString(16);
                          88 == i &&
                            ((k = k.toUpperCase()), (A = A.toUpperCase()));
                        } else
                          112 == i &&
                            (0 === E
                              ? (A = "(nil)")
                              : ((k = "0x"), (A = E.toString(16))));
                      ...
                      case "G":
                        ...
                        if (((u = o("double")), isNaN(u)))
                          ...
                          if (103 == i || 71 == i) {
                            (_ = !0), (y = y || 1);
                            var F = parseInt(
                              u.toExponential(D).split("e")[1],
                              10
                            );
                            y > F && F >= -4
                              ? ((i = (103 == i ? "f" : "F").charCodeAt(0)),
                                (y -= F + 1))
                              : ((i = (103 == i ? "e" : "E").charCodeAt(0)),
                                y--),
                              (D = Math.min(y, 20));
                          }
                          101 == i || 69 == i
          ...
          for (var a = 1; a <= 4; a *= 2) {
            ...
            if (
              ...
              Lr(
                Math.min(
                  o,
                  ((r = Math.max(e, i)) % (t = 65536) > 0 && (r += t - (r % t)),
                  r)
                )
              ))
            )
        ...
        Ia: function (e, r, t) {
          return (e = Ge(e))
            ? ((e.style.width = r + "px"), (e.style.height = t + "px"), 0)
            : -4;
        },
        ...
        Mf: function (e, t) {
          ...
          let i =
            ...
            a.hal &&
            "function" ==
              typeof a.hal.external_transformExternalInterfaceCall &&
        ...
        ld: function (e, t, n, o, a, i, u, s, c) {
          ...
          (f.value = N(e)),
            ...
            (f.style.left = "50%"),
            (f.style.width = "32px"),
            (f.wafSelectionStart = f.wafSelectionEnd =
            ...
            f.addEventListener("keydown", (e) => {
              ...
              const t = e.key,
                ...
                a =
                  ...
                  "/Home/End/ArrowUp/ArrowDown/ArrowLeft/ArrowRight/".indexOf(
                    "/" + t + "/"
                  ) >= 0;
              if (n || a || o)
        ...
        ((function () {
          ...
          if ((re(), r.instantiateWasm))
            try {
              ...
              return (
                p("Module.instantiateWasm callback failed with error: " + e), !1
              );
            }
          (g ||
      ...
      tt = (r._emscripten_builtin_memalign = function () {
        return (tt = r._emscripten_builtin_memalign = r.asm.Bi).apply(
          null,
          arguments
        );
      }),
