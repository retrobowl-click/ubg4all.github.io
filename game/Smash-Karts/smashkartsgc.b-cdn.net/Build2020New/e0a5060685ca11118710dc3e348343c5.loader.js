function createUnityInstance(e, t, r) {
    ...
    function d(e) {
        i(e);
        var t = c.cacheControl(c[e]), r = c.companyName && c.productName ? c.cachedFetch : c.fetchWithProgress,
            o = r(c[e], {
                method: "GET",
    ...
    function u() {
        return new Promise(function (e, t) {
            ...
            r.src = c.frameworkUrl, r.onload = function () {
    ...
    }), window.addEventListener("error", o), window.addEventListener("unhandledrejection", o), c.deinitializers.push(function () {
        c.disableAccessToMediaDevices(), h.forEach(function (t) {
    ...
    var m = {
        Module: c, SetFullscreen: function () {
    ...
    return c.SystemInfo = function () {
        ...
        return s(e, "", 0), !0
    }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), c.fetchWithProgress = function () {
        function e(e, t) {
            if (!t) return 0;
        ...
        function t(t, r) {
            ...
            return r && r.onProgress && (n = r.onProgress), fetch(t, r).then(function (t) {
                ...
                var a = "undefined" != typeof t.body ? t.body.getReader() : void 0,
                    s = "undefined" != typeof t.headers.get("Content-Length"), i = e(t, s), d = new Uint8Array(i),
                    u = [], l = 0, c = 0;
        ...
        var t = {name: "UnityCache", version: 3}, r = {name: "RequestStore", version: 1},
                ...
                return new Promise(function (n, o) {
                    try {
                        ...
                        var a = ["put", "delete", "clear"].indexOf(t) != -1 ? "readwrite" : "readonly",
                            s = this.database.transaction([e], a), i = s.objectStore(e);
        ...
        function s(s, l) {
            ...
            var h = i.getInstance(), p = t("string" == typeof s ? s : s.url), g = {enabled: a(p, l)};
            return l && (g.control = l.control, g.company = l.company, g.product = l.product), g.result = o(p, g.company, g.product, Date.now()), g.revalidated = !1, g.enabled ? h.loadRequest(g.result.url).then(function (t) {
                ...
                if (r(g.result.url) && (o.headers.get("Last-Modified") || o.headers.get("ETag"))) return fetch(g.result.url, {method: "HEAD"}).then(function (t) {
        ...
        var i = c.UnityCache, d = i.RequestStore, u = c.fetchWithProgress;
        ...
        c.SystemInfo.hasWebGL ? c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), c.startupErrorHandler = t, r(0), c.postRun.push(function () {
