...
//         if (t) {
//           for (
//             p = p.slice(0, p.length - 1), e = p.concat(e.split("/")), u = 0;
//             u < e.length;
//             u += 1
//           )
...
//               if (((r = f[p.slice(0, c).join("/")]), r && (r = r[i]))) {
//                 (a = r), (o = u);
//                 break;
//               }
//           if (a) break;
...
//         },
//         module: function (e) {
//           return { id: e, uri: "", exports: f[e], config: l(e) };
//         },
//       }),
//       (u = function (n, r, s, l) {
//         var u,
...
//                 : t(f, c) || t(h, c) || t(m, c)
//                 ? (w[y] = o(c))
//                 : v.p && (v.p.load(v.n, i(l, !0), a(c), {}), (w[y] = f[c]));
//           (g = s.apply(f[n], w)),
//             n &&
//               (u && u.exports !== e && u.exports !== f[n]
//                 ? (f[n] = u.exports)
//                 : (g === e && b) || (f[n] = g));
//         } else n && (f[n] = s);
//       }),
...
//             else
//               for (i in l)
//                 Object.hasOwnProperty.call(l, i) &&
//                   ((r = str(i, l)),
//                   r && o.push(quote(i) + (gap ? ": " : ":") + r));
//             return (
//               (r =
...
//           return null == t || n
//             ? (e.length !== +e.length && (e = h.values(e)),
//               e[h.random(e.length - 1)])
//             : h.shuffle(e).slice(0, Math.max(0, t));
//         });
//       var m = function (e, t) {
//         return null == e
//           ? h.identity
...
//         if (t && h.every(e, h.isArray)) return l.apply(i, e);
//         for (var r = 0, a = e.length; a > r; r++) {
//           var s = e[r];
//           h.isArray(s) || h.isArguments(s)
//             ? t
//               ? o.apply(i, s)
//               : y(s, t, n, i)
//             : n || i.push(s);
...
//               var l = e[o];
//               n && (l = n.call(i, l, o, e)),
//                 (t ? o && a === l : h.contains(a, l)) ||
//                   (t ? (a = l) : a.push(l), r.push(e[o]));
//             }
//             return r;
//           }),
//         (h.union = function () {
...
//         (h.zip = function () {
//           for (
//             var e = h.max(h.pluck(arguments, "length").concat(0)),
//               t = new Array(e),
//               n = 0;
//             e > n;
//             n++
...
//           if (n) {
//             if ("number" != typeof n)
//               return (i = h.sortedIndex(e, t)), e[i] === t ? i : -1;
...
//       (h.bind = function (e, t) {
//         var n, i;
//         if (f && e.bind === f) return f.apply(e, s.call(arguments, 1));
//         if (!h.isFunction(e))
...
//               t > u && u > 0
//                 ? (i = setTimeout(l, t - u))
//                 : ((i = null), n || ((s = e.apply(a, r)), (a = r = null)));
//             };
//           return function () {
//             (a = this), (r = arguments), (o = h.now());
//             var u = n && !i;
//             return (
//               i || (i = setTimeout(l, t)),
...
//         (h.values = function (e) {
//           for (
//             var t = h.keys(e), n = t.length, i = new Array(n), r = 0;
//             n > r;
//             r++
//           )
//             i[r] = e[t[r]];
...
//         (h.extend = function (e) {
//           return h.isObject(e)
//             ? (h.each(s.call(arguments, 1), function (t) {
...
//           else
//             for (
//               var o = l.apply([], s.call(arguments, 1)), u = 0, c = o.length;
//               c > u;
//               u++
//             ) {
//               var r = o[u];
...
//             h.isFunction(t)
//               ? (t = h.negate(t))
//               : ((i = h.map(l.apply([], s.call(arguments, 1)), String)),
//                 (t = function (e, t) {
...
//         } else {
//           for (var d in e)
//             if (h.has(e, d) && (l++, !(c = h.has(t, d) && w(e[d], t[d], n, i))))
//               break;
//           if (c) {
//             for (d in t) if (h.has(t, d) && !l--) break;
//             c = !l;
//           }
//         }
...
//               var e = [this._wrapped];
//               return o.apply(e, arguments), E.call(this, n.apply(h, e));
//             };
//           });
//         });
//       var _ = 0;
...
//         };
//       return { buildQuery: n, appendToUrl: i };
//     });
//   var isOldIE =
//       void 0 !== window.attachEvent && void 0 === window.addEventListener,
//     cdnUrl = isOldIE ? "https://account.y8.com" : "https://cdn.y8.com";
//   define("utils/constants", {
//     root_url: "https://account.y8.com",
//     analytics_url: "https://t.y8.com/log",
...
//               (t = i[r]), t && t.apply(this, n);
//         },
//       };
//     }),
//     define(
//       "runtime",
//       ["require", "underscore", "utils/dom_ready", "event"],
//       function (e) {
//         var t = e("underscore"),
//           n = (e("utils/dom_ready"), e("event"));
//         return {
//           __options: {},
...
//           init: function (e) {
//             this.initialized() ||
//               (this.checkOptions() || this.setOptions(e),
//               this.checkOptions() &&
//                 ((this.__options.initialized = !0), n.fire("id.init")));
//           },
//           reset: function () {
//             this.__options = {};
//           },
...
//             return t.isString(e)
//               ? e
//               : this.__options.globalRedirectUri || document.location.href;
//           },
...
//                 i.GetVariable("$version").match(/(\d+),(\d+),(\d+),(\d+)/),
//                 1
//               )),
//               (i = null);
//           } catch (r) {}
...
//         var e = parent;
//         if ("" !== H)
//           for (var t = 0, n = H.split("."); t < n.length; t++) e = e[n[t]];
//         return e.easyXDM;
//       }
//       function f(t) {
//         return (
...
//         var r = [];
//         for (var o in t) t.hasOwnProperty(o) && r.push(o + "=" + a(t[o]));
//         return (
//           e + (q ? "#" : -1 == e.indexOf("?") ? "?" : "&") + r.join("&") + n
//         );
//       }
//       function b(e) {
...
//             (r in e
//               ? ((i = t[r]),
//                 "object" == typeof i ? w(e[r], i, n) : n || (e[r] = t[r]))
//               : (e[r] = t[r]));
//         return e;
//       }
//       function k() {
...
//         C
//           ? (n = t.createElement(
//               '<iframe title="easyXDM" name="' + e.props.name + '"/>'
//             ))
//           : ((n = t.createElement("IFRAME")),
//             (n.name = e.props.name),
//             (n.title = e.props.name)),
//           (n.id = n.name = e.props.name),
//           delete e.props.name,
//           "string" == typeof e.container &&
//             (e.container = t.getElementById(e.container)),
//           e.container ||
//             (w(n.style, { position: "absolute", top: "-2000px", left: "0px" }),
//             (e.container = t.body));
//         var i = e.props.src;
//         if (
...
//         ) {
//           var r,
//             a = e.container.appendChild(t.createElement("form"));
//           if (
//             ((a.target = n.name),
//             (a.action = i),
//             (a.method = "POST"),
...
//                 (C
//                   ? (r = t.createElement('<input name="' + o + '"/>'))
//                   : ((r = t.createElement("INPUT")), (r.name = o)),
//                 (r.value = e.usePost[o]),
//                 a.appendChild(r));
...
//                 m(n.href) == m(i.remote)
//                   ? "4"
//                   : o(e, "postMessage") || o(t, "postMessage")
//                   ? "1"
//                   : i.swf && o(e, "ActiveXObject") && u()
//                   ? "6"
...
//                   var s,
//                     l = n.protocol + "//" + n.host,
//                     c = t.body.getElementsByTagName("img"),
//                     d = c.length;
//                   d--;

//                 )
//                   if (((s = c[d]), s.src.substring(0, l.length) === l)) {
//                     i.local = s.src;
//                     break;
//                   }
//                 i.local || (i.local = e);
//               }
//               var p = { xdm_c: i.channel, xdm_p: 0 };
//               i.local === e
//                 ? ((i.usePolling = !0),
//                   (i.useParent = !0),
//                   (i.local =
//                     n.protocol + "//" + n.host + n.pathname + n.search),
//                   (p.xdm_e = i.local),
//                   (p.xdm_pa = 1))
//                 : (p.xdm_e = v(i.local)),
//                 i.container && ((i.useResize = !1), (p.xdm_po = 1)),
...
//               });
//             r = [
//               new B.stack.HashTransport(i),
//               new B.stack.ReliableBehavior({}),
//               new B.stack.QueueBehavior({
//                 encode: !0,
//                 maxLength: 4e3 - i.remote.length,
//               }),
//               new B.stack.VerifyBehavior({ initiate: i.isHost }),
//             ];
//             break;
//           case "1":
...
//             break;
//           case "6":
//             E || u(), (r = [new B.stack.FlashTransport(i)]);
//         }
//         return (
//           r.push(new B.stack.QueueBehavior({ lazy: i.lazy, remove: !0 })), r
//         );
//       }
//       function A(e) {
//         for (
...
//           });
//       else {
//         if (!o(e, "attachEvent")) throw new Error("Browser not supported");
//         (N = function (e, t, n) {
//           e.attachEvent("on" + t, n);
//         }),
//           (j = function (e, t, n) {
...
//                 ("loaded" == U || "interactive" == U))))
//           : (J = !!t.body),
//         !J)
//       ) {
//         if (o(e, "addEventListener")) N(t, "DOMContentLoaded", c);
//         else if (
//           (N(t, "readystatechange", function () {
...
//                 var i = t.local[n];
//                 "function" == typeof i && (t.local[n] = { method: i });
//               }
//           var r = A(
//             T(e).concat([
//               new B.stack.RpcBehavior(this, t),
//               {
//                 callback: function (t) {
//                   e.onReady && e.onReady(t);
//                 },
...
//               for (
//                 var e = B.stack.FlashTransport[n].queue, t = 0;
//                 t < e.length;
//                 t++
//               )
//                 e[t]();
...
//                       ? t.getElementById(e.swfContainer)
//                       : e.swfContainer)
...
//               c.postMessage(e.channel, t.toString()), i && i();
//             },
//             destroy: function () {
//               try {
//                 c.destroyChannel(e.channel);
//               } catch (t) {}
//               (c = null), l && (l.parentNode.removeChild(l), (l = null));
//             },
//             onDOMReady: function () {
//               (u = e.remote),
...
//                       (l = x(e)));
//                 };
//               B.stack.FlashTransport[t] && B.stack.FlashTransport[t].init
//                 ? a()
//                 : B.stack.FlashTransport[t]
//                 ? B.stack.FlashTransport[t].queue.push(a)
//                 : ((B.stack.FlashTransport[t] = { queue: [a] }), o(t));
//             },
//             init: function () {
//               d(s.onDOMReady, s);
//             },
...
//               o.up.incoming(e.data.substring(t.channel.length + 1), n);
//           }
//           var o, s, l, u;
//           return (o = {
//             outgoing: function (e, n, i) {
//               l.postMessage(t.channel + " " + e, n || u), i && i();
//             },
//             destroy: function () {
//               j(e, "message", a),
//                 s && ((l = null), s.parentNode.removeChild(s), (s = null));
//             },
//             onDOMReady: function () {
//               if (((u = m(t.remote)), t.isHost)) {
//                 var r = function (n) {
//                   n.data == t.channel + "-ready" &&
//                     ((l =
//                       "postMessage" in s.contentWindow
//                         ? s.contentWindow
...
//                 N(e, "message", a),
//                   (l =
//                     "postMessage" in e.parent ? e.parent : e.parent.document),
...
//                     }))
//                   : (t.referrer &&
//                       m(t.referrer) != X.xdm_e &&
//                       (e.top.location = X.xdm_e),
...
//           function n() {
//             s
//               ? (2 !== ++c && s) || o.up.callback(!0)
//               : (t("ready"), o.up.callback(!0));
//           }
//           function r(e) {
//             o.up.incoming(e, f);
//           }
...
//                 (l = null),
//                 s && (u.parentNode.removeChild(u), (u = null));
//             },
//             onDOMReady: function () {
//               (s = e.isHost),
//                 (c = 0),
...
//                 (e.local = v(e.local)),
//                 s
//                   ? (B.Fn.set(e.channel, function (t) {
//                       s && "ready" === t && (B.Fn.set(e.channel, r), n());
//                     }),
//                     (h = y(e.remote, {
//                       xdm_e: e.local,
//                       xdm_c: e.channel,
...
//                     }),
//                     (u = x(e)))
//                   : ((e.remoteHelper = e.remote), B.Fn.set(e.channel, r));
//               var t = function () {
//                 var r = l || this;
//                 j(r, "load", t),
//                   B.Fn.set(e.channel + "_load", a),
//                   (function o() {
//                     "function" == typeof r.contentWindow.sendMessage
//                       ? n()
//                       : i(o, 50);
//                   })();
//               };
//               l = x({ props: { src: e.local + "#_4" + e.channel }, onLoad: t });
//             },
//             init: function () {
//               d(o.onDOMReady, o);
//             },
...
//                 l[0] == n && ((r = ""), t && t(!0)),
//                 a.length > 0 &&
//                   (e.down.outgoing(l[1] + "," + n + "_" + r, o),
//                   i != l[1] && ((i = l[1]), e.up.incoming(a, o)));
//             },
//             outgoing: function (a, o, s) {
//               (r = a), (t = s), e.down.outgoing(i + "," + ++n + "_" + a, o);
//             },
//           });
//         }),
//         (B.stack.QueueBehavior = function (e) {
//           function t() {
//             if (e.remove && 0 === s.length) return void S(n);
//             if (!l && 0 !== s.length && !o) {
//               l = !0;
//               var r = s.shift();
...
//                 (u += t.substring(a + 1)),
//                   0 === o &&
//                     (e.encode && (u = r(u)), n.up.incoming(u, i), (u = ""));
...
//                   });
//               } else s.push({ data: i, origin: r, callback: o });
//               d ? n.down.init() : t();
//             },
//             destroy: function () {
//               (o = !0), n.down.destroy();
...
//                 ? a === i
//                   ? n.up.callback(!0)
//                   : r || ((r = a), e.initiate || t(), n.down.outgoing(a))
//                 : a.substring(0, s) === r &&
//                   n.up.incoming(a.substring(s + 1), o);
//             },
...
//           function n(e) {
//             (e.jsonrpc = "2.0"), a.down.outgoing(o.stringify(e));
//           }
//           function i(e, t) {
...
//                 a = arguments.length,
//                 o = { method: t };
//               a > 0 && "function" == typeof arguments[a - 1]
//                 ? (a > 1 && "function" == typeof arguments[a - 2]
//                     ? ((r = {
//                         success: arguments[a - 2],
//                         error: arguments[a - 1],
//                       }),
//                       (o.params = i.call(arguments, 0, a - 2)))
//                     : ((r = { success: arguments[a - 1] }),
//                       (o.params = i.call(arguments, 0, a - 1))),
//                   (u["" + ++s] = r),
//                   (o.id = s))
//                 : (o.params = i.call(arguments, 0)),
//                 e.namedParams &&
//                   1 === o.params.length &&
//                   (o.params = o.params[0]),
//                 n(o);
...
//                 (o = function (e, i) {
//                   o = M;
//                   var r = { id: t, error: { code: -32099, message: e } };
...
//                 t.handle
//                   ? t.handle(i, n)
//                   : r(i.method, i.id, t.local[i.method], i.params);
//               else {
//                 var a = u[i.id];
//                 i.error
//                   ? a.error && a.error(i.error)
//                   : a.success && a.success(i.result),
//                   delete u[i.id];
//               }
//             },
//             init: function () {
...
//     define(
//       "rpc",
//       ["utils/constants", "runtime", "easyXDM/easyXDM"],
//       function (e, t, n) {
//         var i = { events: {} },
//           r = {},
//           a = {
...
//           o = null;
//         return (
//           t.channelUrl && (r.local = t.channelUrl),
...
//             return null === o && (o = new n.Rpc(r, a)), o;
//           }),
//           i
//         );
//       }
...
//             m =
//               /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))/.exec(
//                 e
//               ),
//             v = /(Mac OS X)|(Windows)|(Linux)/.exec(e);
//           if (
//             ((d = /\b(iPhone|iP[ao]d)/.exec(e)),
//             (p = /\b(iP[ao]d)/.exec(e)),
//             (u = /Android/i.exec(e)),
//             (f = /FBAN\/\w+;/i.exec(e)),
//             (h = /Mobile/i.exec(e)),
...
//       var i = e.extend({}, t);
//       return (
//         (i.animate = function (t, i, r, a, o, s, l, u) {
//           if (o && s && l) {
//             var c = t,
//               d = i,
//               p = r,
...
//           return (
//             this.animate(this.width(), e, this.height(), t, 30, 1, 2, n), this
//           );
//         }),
//         i
//       );
...
//               n = Array.prototype.slice.call(this.getSubscribers(e)),
//               i = 0;
//             i < n.length;
//             i++
//           )
...
//           return (
//             this.__observableEvents[e] || (this.__observableEvents[e] = [])
//           );
//         },
...
//         };
//         return (
//           (l.prototype = e.extend(l.prototype, r)),
...
//               t.setAttribute(
//                 "style",
//                 "position:fixed; z-index:9000; overflow:hidden; border-radius: 3px;"
//               ),
...
//                 "background: url(" +
//                   s.assetsRootUrl() +
//                   "/assets/tinybox/preload.gif) no-repeat 50% 50%; overflow:hidden; line-height:0;"
//               ),
//               this.embedded
//                 ? a.setAttribute(
//                     "style",
//                     'position:absolute; top:0px; left:0px; height:100%; width:100%; background:#000; z-index:800; opacity:0; -moz-opacity:0; filter:alpha(opacity=0); overflow:hidden; zoom:1; -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)"; -khtml-opacity:0; pointer-events: none; '
//                   )
//                 : a.setAttribute(
//                     "style",
//                     'position:absolute; top:0px; left:0px; height:100%; width:100%; background:#000; z-index:800; opacity:0.8; -moz-opacity:0.8; filter:alpha(opacity=80); overflow:hidden; zoom:1; -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=80)"; -khtml-opacity:0.5;'
//                   ),
...
//             };
//             return window.setTimeout(e.bind(t, this), 500), window.focus(), !0;
//           }),
...
//             t &&
//               (e.isString(t)
//                 ? (this.findContent().innerHTML = t)
//                 : ((this.findContent().innerHTML = ""),
...
//             return this.called
//               ? void 0
//               : ((this.called = !0), this.successFn(e));
//           }),
...
//             r,
//             a,
//             s = this.locales.get(t.locale).slice();
...
//               for (
//                 ;
//                 i.length && ((a = a[i.shift()]), void 0 !== a && null !== a);
...
//             s,
//             l,
//             u = this.locales.get(n.locale).slice();
...
//             ) {
//               for (; a.length && ((s = s[a.shift()]), r(s)); )
//                 0 === a.length &&
//                   (l = this.pluralizationLookupWithoutFallback(e, i, s));
//               if ("undefined" != typeof l && null !== l) break;
//             }
//           return (
...
//           var n = [{ scope: e }];
//           return (
//             o(t.defaults) && (n = n.concat(t.defaults)),
//             o(t.defaultValue) && n.push({ message: t.defaultValue }),
//             n
//           );
//         }),
...
//           t = t || {};
//           var n,
//             i = this.createTranslationOptions(e, t),
//             a = e,
//             l = this.prepareOptions(t);
//           delete l.defaultValue;
//           var u = i.some(function (t) {
//             return (
//               o(t.scope)
//                 ? ((a = t.scope), (n = this.lookup(a, l)))
//                 : o(t.message) && (n = f(t.message, e)),
...
//                   }, this))
//                 : r(n) && o(t.count) && (n = this.pluralize(t.count, a, t)),
//               n)
//             : this.missingTranslation(e, t);
//         }),
...
//             r,
//             a,
//             s = e.match(this.placeholder);
//           if (!s) return e;
//           for (; s.length; )
//             (n = s.shift()),
//               (r = n.replace(this.placeholder, "$1")),
//               (i = o(t[r])
//                 ? t[r].toString().replace(/\$/gm, "_#$#_")
//                 : r in t
//                 ? this.nullPlaceholder(n, e, t)
//                 : this.missingPlaceholder(n, e, t)),
//               (a = new RegExp(n.replace(/{/gm, "\\{").replace(/}/gm, "\\}"))),
//               (e = e.replace(a, i));
//           return e.replace(/_#\$#_/g, "$");
//         }),
//         (e.pluralize = function (e, t, n) {
//           n = this.prepareOptions({ count: String(e) }, n);
//           var i, r;
//           return (
//             (r = this.pluralizationLookup(e, t, n)),
//             "undefined" == typeof r.translations || null == r.translations
//               ? this.missingTranslation(t, n)
//               : "undefined" != typeof r.message && null != r.message
//               ? this.interpolate(r.message, n)
...
//           }
//           var i =
//               null != t && null != t.locale ? t.locale : this.currentLocale(),
...
//             r,
//             a = 0 > e,
//             o = i(Math.abs(e), t.precision).toString(),
//             s = o.split("."),
//             l = [],
//             u = t.format || "%n",
//             c = a ? "-" : "";
//           for (e = s[0], n = s[1]; e.length > 0; )
...
//               (n = t[8]
//                 ? new Date(Date.UTC(t[1], t[2], t[3], t[4], t[5], t[6], i))
//                 : new Date(t[1], t[2], t[3], t[4], t[5], t[6], i));
//           } else
//             "number" == typeof e
//               ? ((n = new Date()), n.setTime(e))
//               : e.match(
...
//                 ))
//               : e.match(/\d+ \d+:\d+:\d+ [+-]\d+ \d+/)
//               ? ((n = new Date()), n.setTime(Date.parse(e)))
//               : ((n = new Date()), n.setTime(Date.parse(e)));
//           return n;
//         }),
...
//             a = e.meridian();
//           if (
//             (r || (r = {}), (r = this.prepareOptions(r, g)), isNaN(t.getTime()))
//           )
//             throw new Error(
...
//                 })),
//                 (i = 0))
//               : ((n = this.t("number.human.storage_units.units." + b[o])),
...
//           return "undefined" == typeof e && "undefined" == typeof t
//             ? {}
//             : h(e, t);
//         }),
...
//         (e.translations.ar = JSON.parse(
//           '{"sdk":{"default_table_title":"Ø£Ø¹Ù„ÙŠ Ø§Ù„Ù†ØªØ§Ø¦Ø¬","language":{"ar":"Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©","cs":"Ø§Ù„ØªØ´ÙŠÙƒÙŠØ©","de":"Ø§Ù„Ø£Ù„Ù…Ø§Ù†ÙŠØ©","el":"Ø§Ù„ÙŠÙˆÙ†Ø§Ù†ÙŠØ©","en":"Ø§Ù„Ø¥Ù†Ø¬Ù„ÙŠØ²ÙŠØ©","es":"Ø§Ù„Ø¥Ø³Ø¨Ø§Ù†ÙŠØ©","fr":"Ø§Ù„ÙØ±Ù†Ø³ÙŠØ©","he":"Ø§Ù„Ø¹Ø¨Ø±ÙŠØ©","hi":"Ø§Ù„Ù‡Ù†Ø¯ÙŠØ©","id":"Ø§Ù„Ø£Ù†Ø¯ÙˆÙ†ÙŠØ³ÙŠØ©","it":"Ø§Ù„Ø¥ÙŠØ·Ø§Ù„ÙŠØ©","ja":"Ø§Ù„ÙŠØ§Ø¨Ø§Ù†ÙŠØ©","ko":"Ø§Ù„ÙƒÙˆØ±ÙŠØ©","nl":"Ø§Ù„Ù‡ÙˆÙ„Ù†Ø¯ÙŠØ©","pl":"Ø§Ù„Ø¨ÙˆÙ„Ù†Ø¯ÙŠØ©","pt":"Ø§Ù„Ø¨Ø±ØªØºØ§Ù„ÙŠØ©","pt-BR":"Ø§Ù„Ø¨Ø±ØªØºØ§Ù„ÙŠØ© Ø§Ù„Ø¨Ø±Ø§Ø²ÙŠÙ„ÙŠØ©","ro":"Ø§Ù„Ø±ÙˆÙ…Ø§Ù†ÙŠØ©","ru":"Ø§Ù„Ø±ÙˆØ³ÙŠØ©","th":"Ø§Ù„ØªØ§ÙŠÙ„Ø§Ù†Ø¯ÙŠØ©","tl":"Ø§Ù„ØªØ§ØºÙ„ÙˆØºÙŠØ©","tr":"Ø§Ù„ØªØ±ÙƒÙŠØ©","vi-VN":"Ø§Ù„ÙÙŠØªÙ†Ø§Ù…ÙŠØ©","zh":"Ø§Ù„ØµÙŠÙ†ÙŠØ©"},"login":{"email":"Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ","footer1":"Ù„Ø§ ØªÙ…ØªÙ„Ùƒ Ø­Ø³Ø§Ø¨Ù‹Ø§ØŸ","footer2":"Ø¥Ù†Ø´Ø§Ø¡ Ø­Ø³Ø§Ø¨","forgot":"Ù‡Ù„ Ù†Ø³ÙŠØª ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±ØŸ","password":"ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±","title":"ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„"},"playtomic":{"achievements":"Ø§Ù„Ø¥Ù†Ø¬Ø§Ø²Ø§Øª","alltime":"ÙƒÙ„ Ø§Ù„ÙˆÙ‚Øª","new_account":"Ø­Ø³Ø§Ø¨ Ø¬Ø¯ÙŠØ¯","newest":"Ø§Ù„Ø£Ø­Ø¯Ø«","page":"%{num} ØµÙØ­Ø©","personal_best":"Ø£ÙØ¶Ù„ Ù†ØªØ§Ø¦Ø¬Ùƒ","seven_days":"7 Ø£ÙŠØ§Ù…","thirty_days":"ÙŠÙˆÙ…Ù‹Ø§ 30"},"register":"Ø§Ù„ØªØ³Ø¬ÙŠÙ„","registration":{"apr":"Ø£Ø¨Ø±ÙŠÙ„","aug":"Ø£ØºØ³Ø·Ø³","city":"Ø§Ù„Ù…Ø¯ÙŠÙ†Ø©","country":"Ø§Ù„Ø¯ÙˆÙ„Ø©","dec":"Ø¯ÙŠØ³Ù…Ø¨Ø±","dob":"ØªØ§Ø±ÙŠØ® Ø§Ù„Ù…ÙŠÙ„Ø§Ø¯","email":"Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ","feb":"ÙØ¨Ø±Ø§ÙŠØ±","female":"Ø£Ù†Ø«Ù‰","first-name":"Ø§Ù„Ø§Ø³Ù… Ø§Ù„Ø£ÙˆÙ„","footer1":"Ù‡Ù„ Ù„Ø¯ÙŠÙƒ Ø­Ø³Ø§Ø¨ Ø¨Ø§Ù„ÙØ¹Ù„ØŸ","footer2":"ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„","footer3":"ÙŠØ´ÙŠØ± Ø§Ù„Ù†Ù‚Ø± ÙÙˆÙ‚ Ø¥Ù†Ù‡Ø§Ø¡ Ø¥Ù„Ù‰ Ø£Ù†Ùƒ Ù‚Ø§Ø¯Ø± Ø¹Ù„Ù‰ Ù‚Ø±Ø§Ø¡Ø© ÙˆÙ‚Ø±Ø£Øª ÙˆÙˆØ§ÙÙ‚Øª Ø¹Ù„Ù‰","jan":"ÙŠÙ†Ø§ÙŠØ±","june":"ÙŠÙˆÙ†ÙŠÙ‡","language":"Ø§Ù„Ù„ØºØ©","last-name":"Ø§Ù„Ø§Ø³Ù… Ø§Ù„Ø£Ø®ÙŠØ±","male":"Ø°ÙƒØ±","mar":"Ù…Ø§Ø±Ø³","may":"Ù…Ø§ÙŠÙˆ","month":"Ø§Ù„Ø´Ù‡Ø±","nickname":"Ø§Ù„Ù„Ù‚Ø¨","nov":"Ù†ÙˆÙÙ…Ø¨Ø±","oct":"Ø£ÙƒØªÙˆØ¨Ø±","password":"ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±","sep":"Ø³Ø¨ØªÙ…Ø¨Ø±","state":"Ø§Ù„ÙˆÙ„Ø§ÙŠØ© Ø£Ùˆ Ø§Ù„Ù…Ø­Ø§ÙØ¸Ø©","street":"Ø¹Ù†ÙˆØ§Ù† Ø§Ù„Ø´Ø§Ø±Ø¹","title":"Ø§Ù„ØªØ³Ø¬ÙŠÙ„","zip":"Ø§Ù„Ø±Ù…Ø² Ø§Ù„Ø¨Ø±ÙŠØ¯ÙŠ"}}}'
//         )),
//         (e.translations.cs = JSON.parse(
//           '{"sdk":{"default_table_title":"Tabulky playtomic","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"All Time","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"Personal best","seven_days":"7 Days","thirty_days":"30 Days"},"register":"Registrace","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.de = JSON.parse(
//           '{"sdk":{"default_table_title":"High Scores","language":{"ar":"Arabisch","cs":"Tschechisch","de":"Deutsch","el":"Griechisch","en":"Englisch","es":"Spanisch","fr":"FranzÃ¶sisch","he":"HebrÃ¤isch","hi":"Hindi","id":"Indonesisch","it":"Italienisch","ja":"Japanisch","ko":"Koreanisch","nl":"NiederlÃ¤ndisch","pl":"Polnisch","pt":"Portugiesisch","pt-BR":"Brazilianisches Portugeisisch","ro":"RomÃ¤nisch","ru":"Russisch","th":"ThailÃ¤ndisch","tl":"Tagalog","tr":"TÃ¼rkisch","vi-VN":"Vietnamesisch","zh":"Chinesisch"},"login":{"email":"Email","footer1":"Du hast kein Konto?","footer2":"Erstelle ein Konto","forgot":"Passwort vergessen?","password":"Passwort","title":"Login"},"playtomic":{"achievements":"Erfolge","alltime":"Jederzeit","new_account":"Neuer Account","newest":"Neueste","page":"Seite %{num}","personal_best":"PersÃ¶nliche Bestleistung","seven_days":"7 Tage","thirty_days":"30 Tage"},"register":"Registrieren","registration":{"apr":"April","aug":"August","city":"Stadt","country":"Land","dec":"Dezember","dob":"Geburtstag","email":"Email","feb":"Februar","female":"Weiblich","first-name":"Vorname","footer1":"Du hast schon ein Konto?","footer2":"Login","footer3":"Wenn Sie Beenden klicken bestÃ¤tigen Sie das Lesen, die Zustimmung und die Anforderungen der","jan":"Januar","june":"Juni","language":"Sprache","last-name":"Nachname","male":"MÃ¤nnlich","mar":"MÃ¤rz","may":"MÃ¤rz","month":"Monat","nickname":"Spitzname","nov":"November","oct":"Oktober","password":"Passwort","sep":"September","state":"Provinz","street":"Adresse","title":"Registrierung","zip":"Postleitzahl"}}}'
//         )),
//         (e.translations.el = JSON.parse(
//           '{"sdk":{"default_table_title":"Î¥ÏˆÎ·Î»Î¬ ÏƒÎºÎ¿Ï","language":{"ar":"Î‘ÏÎ±Î²Î¹ÎºÎ¬","cs":"Î¤ÏƒÎ­Ï‡Î¹ÎºÎ±","de":"Î“ÎµÏÎ¼Î±Î½Î¹ÎºÎ¬","el":"Î•Î»Î»Î·Î½Î¹ÎºÎ¬","en":"Î‘Î³Î³Î»Î¹ÎºÎ¬","es":"Î™ÏƒÏ€Î±Î½Î¹ÎºÎ¬","fr":"Î“Î±Î»Î»Î¹ÎºÎ¬","he":"Î•Î²ÏÎ±ÏŠÎºÎ¬","hi":"Î§Î¯Î½Ï„Î¹","id":"Î™Î½Î´Î¿Î½Î·ÏƒÎ¹Î±ÎºÎ¬","it":"Î™Ï„Î±Î»Î¹ÎºÎ¬","ja":"Î™Î±Ï€Ï‰Î½Î¹ÎºÎ¬","ko":"ÎšÎ¿ÏÎµÎ¬Ï„Î¹ÎºÎ±","nl":"ÎŸÎ»Î»Î±Î½Î´Î¹ÎºÎ¬","pl":"Î Î¿Î»Ï‰Î½Î¹ÎºÎ¬","pt":"Î Î¿ÏÏ„Î¿Î³Î±Î»Î¹ÎºÎ¬","pt-BR":"Î’ÏÎ±Î¶Î¹Î»Î¹Î¬Î½Î¹ÎºÎ±","ro":"Î¡Î¿Ï…Î¼Î¬Î½Î¹ÎºÎ±","ru":"Î¡ÏŽÏƒÎ¹ÎºÎ±","th":"Î¤Î±ÏŠÎ»Î±Î½Î´Î­Î¶Î¹ÎºÎ±","tl":"Tagalog","tr":"Î¤Î¿ÏÏÎºÎ¹ÎºÎ±","vi-VN":"Î’Î¹ÎµÏ„Î½Î±Î¼Î­Î¶Î¹ÎºÎ±","zh":"ÎšÎ¹Î½Î­Î¶Î¹ÎºÎ±"},"login":{"email":"Email","footer1":"Î”ÎµÎ½ Î­Ï‡ÎµÏ„Îµ Î»Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼ÏŒ;","footer2":"Î”Î·Î¼Î¹Î¿Ï…ÏÎ³Î®ÏƒÏ„Îµ Î»Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼ÏŒ","forgot":"ÎžÎµÏ‡Î¬ÏƒÎ±Ï„Îµ Ï„Î¿ ÎºÏ‰Î´Î¹ÎºÏŒ;","password":"ÎšÏ‰Î´Î¹ÎºÏŒÏ‚","title":"Î£ÏÎ½Î´ÎµÏƒÎ·"},"playtomic":{"achievements":"Î•Ï€Î¹Ï„ÎµÏÎ³Î¼Î±Ï„Î±","alltime":"Î£Ï…Î½ÎµÏ‡ÏŽÏ‚","new_account":"ÎÎ­Î¿Ï‚ Î›Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼ÏŒÏ‚","newest":"ÎÎµÏŒÏ„ÎµÏÎ±","page":"Î£ÎµÎ»Î¯Î´Î± %{num}","personal_best":"Î ÏÎ¿ÏƒÏ‰Ï€Î¹ÎºÏŒ ÏÎµÎºÏŒÏ","seven_days":"7 ÎœÎ­ÏÎµÏ‚","thirty_days":"30 ÎœÎ­ÏÎµÏ‚"},"register":"Î•Î³Î³ÏÎ±Ï†ÎµÎ¯Ï„Îµ","registration":{"apr":"Î‘Ï€ÏÎ¯Î»Î¹Î¿Ï‚","aug":"Î‘ÏÎ³Î¿Ï…ÏƒÏ„Î¿Ï‚","city":"Î ÏŒÎ»Î·","country":"Î§ÏŽÏÎ±","dec":"Î”ÎµÎºÎ­Î¼Î²ÏÎ¹Î¿Ï‚","dob":"Î—Î¼ÎµÏÎ¿Î¼Î·Î½Î¯Î± Î“Î­Î½Î½Î·ÏƒÎ·Ï‚","email":"Email","feb":"Î¦ÎµÎ²ÏÎ¿Ï…Î¬ÏÎ¹Î¿Ï‚","female":"Î“Ï…Î½Î±Î¯ÎºÎ±","first-name":"ÎŒÎ½Î¿Î¼Î±","footer1":"ÎˆÏ‡ÎµÏ„Îµ Î®Î´Î· Î»Î¿Î³Î±ÏÎ¹Î±ÏƒÎ¼ÏŒ;","footer2":"Î•Î¯ÏƒÎ¿Î´Î¿Ï‚","footer3":"Î Î±Ï„ÏŽÎ½Ï„Î±Ï‚ Î¿Î»Î¿ÎºÎ»Î®ÏÏ‰ÏƒÎ· Î±Ï€Î¿Î´Î­Ï‡ÎµÏƒÏ„Îµ ÏŒÏ„Î¹ Î­Ï‡ÎµÏ„Îµ Î´Î¹Î±Î²Î¬ÏƒÎµÎ¹ ÎºÎ±Î¹ ÏƒÏ…Î¼Ï†Ï‰Î½ÎµÎ¯Ï„Îµ Î¼Îµ Ï„Î¿Ï…Ï‚","jan":"Î™Î±Î½Î¿Ï…Î¬ÏÎ¹Î¿Ï‚","june":"Î™Î¿ÏÎ½Î¹Î¿Ï‚","language":"Î“Î»ÏŽÏƒÏƒÎ±","last-name":"Î•Ï€ÏŽÎ½Ï…Î¼Î¿","male":"Î†Î½Î´ÏÎ±Ï‚","mar":"ÎœÎ¬ÏÏ„Î¹Î¿Ï‚","may":"ÎœÎ¬Î¹Î¿Ï‚","month":"ÎœÎ®Î½Î±Ï‚","nickname":"Î¨ÎµÏ…Î´ÏŽÎ½Ï…Î¼Î¿","nov":"ÎÎ¿Î­Î¼Î²ÏÎ¹Î¿Ï‚","oct":"ÎŸÎºÏ„ÏŽÎ²ÏÎ¹Î¿Ï‚","password":"ÎšÏ‰Î´Î¹ÎºÏŒÏ‚","sep":"Î£ÎµÏ€Ï„Î­Î¼Î²ÏÎ¹Î¿Ï‚","state":"ÎÎ¿Î¼ÏŒÏ‚","street":"ÎŸÎ´ÏŒÏ‚","title":"Î•Î³Î³ÏÎ±Ï†Î®","zip":"Î¤.Îš."}}}'
//         )),
//         (e.translations.en = JSON.parse(
//           '{"sdk":{"default_table_title":"High Scores","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"All Time","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"Personal best","seven_days":"7 Days","thirty_days":"30 Days"},"register":"Register","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.es = JSON.parse(
//           '{"sdk":{"default_table_title":"Puntuaciones Altas","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"Todos los Tiempos","new_account":"New Account","newest":"Lo MÃ¡s Nuevo","page":"Page %{num}","personal_best":"Record Personal","seven_days":"7 DÃ­as","thirty_days":"30 DÃ­as"},"register":"Registrarse","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.fr = JSON.parse(
//           '{"sdk":{"default_table_title":"Meilleurs scores","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"Tout le temps","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"Record personnel","seven_days":"7 Days","thirty_days":"30 Days"},"register":"S\'inscrire","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.he = JSON.parse(
//           '{"sdk":{"default_table_title":"×ª×•×¦××•×ª ×’×‘×•×”×•×ª","language":{"ar":"×¢×¨×‘×™×ª","cs":"×¦\'×›×™×ª","de":"×’×¨×ž× ×™×ª","el":"×™×•×•× ×™×ª","en":"×× ×’×œ×™×ª","es":"×¡×¤×¨×“×™×ª","fr":"×¦×¨×¤×ª×™×ª","he":"×¢×‘×¨×™×ª","hi":"×”×•×“×™×ª","id":"××™× ×“×•× ×–×™×ª","it":"××™×˜×œ×§×™×ª","ja":"×™×¤× ×™×ª","ko":"×§×•×¨×™×× ×™×ª","nl":"×”×•×œ× ×“×™×ª","pl":"×¤×•×œ× ×™×ª","pt":"×¤×•×¨×˜×•×’×–×™×ª","pt-BR":"×¤×•×¨×˜×•×’×–×™×ª ×‘×¨×–×™×œ××™×ª","ro":"×¨×•×ž× ×™×ª","ru":"×¨×•×¡×™×ª","th":"×ª××™×œ× ×“×™×ª","tl":"×˜××’×œ×•×’","tr":"×˜×•×¨×§×™×ª","vi-VN":"×•×™××˜× ×ž×™×ª","zh":"×¡×™× ×™×ª"},"login":{"email":"××™×ž×™×™×œ","footer1":"××™×Ÿ ×œ×š ×—×©×‘×•×Ÿ?","footer2":"×™×¦×™×¨×ª ×—×©×‘×•×Ÿ","forgot":"×©×›×—×ª ×¡×™×¡×ž×?","password":"×¡×™×¡×ž×","title":"×”×ª×—×‘×¨×•×ª"},"playtomic":{"achievements":"×”×™×©×’×™×","alltime":"×›×œ ×”×–×ž× ×™×","new_account":"×—×©×‘×•×Ÿ ×—×“×©","newest":"×”×›×™ ×—×“×©","page":"×¢×ž×•×“ %{num}","personal_best":"×ª×•×¦××” ×’×‘×•×”×” ××™×©×™×ª","seven_days":"7 ×™×ž×™×","thirty_days":"30 ×™×ž×™×"},"register":"×”×¨×©×ž×”","registration":{"apr":"××¤×¨×™×œ","aug":"××•×’×•×¡×˜","city":"×¢×™×¨","country":"×ž×“×™× ×”","dec":"×“×¦×ž×‘×¨","dob":"×ª××¨×™×š ×œ×™×“×”","email":"××™×ž×™×™×œ","feb":"×¤×‘×¨×•××¨","female":"× ×§×‘×”","first-name":"×©× ×¤×¨×˜×™","footer1":"×›×‘×¨ ×™×© ×œ×š ×—×©×‘×•×Ÿ?","footer2":"×”×ª×—×‘×¨×•×ª","footer3":"×‘×œ×—×™×¦×” ×¢×œ ×¡×™×•× ×”× ×š ×ž××©×¨/×ª ×©×§×¨××ª ×•×”×¡×›×ž×ª ×œ","jan":"×™× ×•××¨","june":"×™×•× ×™","language":"×©×¤×”","last-name":"×©× ×ž×©×¤×—×”","male":"×–×›×¨","mar":"×ž×¨×¥","may":"×ž××™","month":"×—×•×“×©","nickname":"×›×™× ×•×™","nov":"× ×•×‘×ž×‘×¨","oct":"××•×§×˜×•×‘×¨","password":"×¡×™×¡×ž×","sep":"×¡×¤×˜×ž×‘×¨","state":"×ž×—×•×–","street":"×›×ª×•×‘×ª","title":"×”×¨×©×ž×”","zip":"×ž×™×§×•×“"}}}'
//         )),
//         (e.translations.hi = JSON.parse(
//           '{"sdk":{"default_table_title":"à¤‰à¤šà¥à¤š à¤¸à¥à¤•à¥‹à¤°","language":{"ar":"à¤…à¤°à¤¬à¥€","cs":"à¤šà¥‡à¤•","de":"à¤œà¤°à¥à¤®à¤¨","el":"à¤—à¥à¤°à¥€à¤•","en":"à¤…à¤‚à¤—à¥à¤°à¥‡à¤œà¤¼à¥€","es":"à¤¸à¥à¤ªà¥ˆà¤¨à¤¿à¤¶","fr":"à¤«à¥à¤°à¤¾à¤‚à¤¸à¥€à¤¸à¥€","he":"à¤¹à¤¿à¤¬à¥à¤°à¥‚","hi":"à¤¹à¤¿à¤¨à¥à¤¦à¥€","id":"à¤‡à¤‚à¤¡à¥‹à¤¨à¥‡à¤¶à¤¿à¤¯à¤¾à¤ˆ","it":"à¤‡à¤¤à¤¾à¤²à¤µà¥€","ja":"à¤œà¤¾à¤ªà¤¾à¤¨à¥€","ko":"à¤•à¥‹à¤°à¤¿à¤¯à¤¾à¤ˆ","nl":"à¤¡à¤š","pl":"à¤ªà¥‹à¤²à¤¿à¤¶","pt":"à¤ªà¥à¤°à¥à¤¤à¤—à¤¾à¤²à¥€","pt-BR":"à¤¬à¥à¤°à¤¾à¤œà¤¼à¥€à¤²à¤¿à¤¯à¤¾à¤ˆ à¤ªà¥à¤°à¥à¤¤à¤—à¤¾à¤²à¥€","ro":"à¤°à¥‹à¤®à¤¾à¤¨à¤¿à¤¯à¤¨","ru":"à¤°à¥‚à¤¸à¥€","th":"à¤¥à¤¾à¤ˆ","tl":"à¤Ÿà¤¾à¤—à¤¾à¤²à¥‹à¤—","tr":"à¤¤à¥à¤°à¥à¤•à¥€","vi-VN":"à¤µà¤¿à¤¯à¤¤à¤¨à¤¾à¤®à¥€","zh":"à¤šà¥€à¤¨à¥€"},"login":{"email":"à¤ˆà¤®à¥‡à¤²","footer1":"à¤–à¤¾à¤¤à¤¾ à¤¨à¤¹à¥€à¤‚ à¤¹à¥ˆ?","footer2":"à¤à¤• à¤–à¤¾à¤¤à¤¾ à¤¬à¤¨à¤¾à¤à¤‚","forgot":"à¤ªà¤¾à¤¸à¤µà¤°à¥à¤¡ à¤­à¥‚à¤² à¤—à¤?","password":"à¤ªà¤¾à¤¸à¤µà¤°à¥à¤¡","title":"à¤²à¥‰à¤—à¤¿à¤¨"},"playtomic":{"achievements":"à¤‰à¤ªà¤²à¤¬à¥à¤§à¤¿à¤¯à¤¾à¤‚","alltime":"à¤ªà¥‚à¤°à¤¾ à¤¸à¤®à¤¯","new_account":"à¤¨à¤¯à¤¾ à¤–à¤¾à¤¤à¤¾","newest":"à¤¨à¤µà¥€à¤¨à¤¤à¤®","page":"à¤ªà¥‡à¤œ %{num}","personal_best":"à¤µà¥à¤¯à¤•à¥à¤¤à¤¿à¤—à¤¤ à¤¸à¤°à¥à¤µà¤¶à¥à¤°à¥‡à¤·à¥à¤ ","seven_days":"7 à¤¦à¤¿à¤¨","thirty_days":"30 à¤¦à¤¿à¤¨"},"register":"à¤°à¤œà¤¿à¤¸à¥à¤Ÿà¤° à¤•à¤°à¥‡à¤‚","registration":{"apr":"à¤…à¤ªà¥à¤°à¥ˆà¤²","aug":"à¤…à¤—à¤¸à¥à¤¤","city":"à¤¶à¤¹à¤°","country":"à¤¦à¥‡à¤¶","dec":"à¤¦à¤¿à¤¸à¤®à¥à¤¬à¤°","dob":"à¤œà¤¨à¥à¤® à¤•à¥€ à¤¤à¤¾à¤°à¥€à¤–","email":"à¤ˆà¤®à¥‡à¤²","feb":"à¤«à¤¼à¤°à¤µà¤°à¥€","female":"à¤¸à¥à¤¤à¥à¤°à¥€","first-name":"à¤ªà¤¹à¤²à¤¾ à¤¨à¤¾à¤®","footer1":"à¤ªà¤¹à¤²à¥‡ à¤¸à¥‡ à¤à¤• à¤–à¤¾à¤¤à¤¾ à¤¹à¥ˆ?","footer2":"à¤²à¥‰à¤—à¤¿à¤¨","footer3":"à¤¸à¤®à¤¾à¤ªà¥à¤¤ à¤ªà¤° à¤•à¥à¤²à¤¿à¤• à¤•à¤°à¤¨à¥‡ à¤•à¤¾ à¤…à¤°à¥à¤¥ à¤¹à¥ˆ à¤•à¤¿ à¤†à¤ªà¤¨à¥‡ à¤‡à¤¸à¥‡ à¤ªà¤¢à¤¼à¤¾ à¤¹à¥ˆ à¤”à¤° à¤‡à¤¸à¤¸à¥‡ à¤¸à¤¹à¤®à¤¤ à¤¹à¥ˆà¤‚:","jan":"à¤œà¤¨à¤µà¤°à¥€","june":"à¤œà¥‚à¤¨","language":"à¤­à¤¾à¤·à¤¾","last-name":"à¤…à¤‚à¤¤à¤¿à¤® à¤¨à¤¾à¤®","male":"à¤ªà¥à¤°à¥à¤·","mar":"à¤®à¤¾à¤°à¥à¤š","may":"à¤®à¤ˆ","month":"à¤®à¤¹à¥€à¤¨à¤¾","nickname":"à¤‰à¤ªà¤¨à¤¾à¤®","nov":"à¤¨à¤µà¤®à¥à¤¬à¤°","oct":"à¤…à¤•à¥à¤Ÿà¥‚à¤¬à¤°","password":"à¤ªà¤¾à¤¸à¤µà¤°à¥à¤¡","sep":"à¤¸à¤¿à¤¤à¤®à¥à¤¬à¤°","state":"à¤°à¤¾à¤œà¥à¤¯ à¤¯à¤¾ à¤ªà¥à¤°à¤¾à¤‚à¤¤","street":"à¤ªà¤¤à¤¾","title":"à¤°à¤œà¤¿à¤¸à¥à¤Ÿà¤° à¤•à¤°à¥‡à¤‚","zip":"à¤œà¤¼à¤¿à¤ª à¤•à¥‹à¤¡"}}}'
//         )),
//         (e.translations.id = JSON.parse(
//           '{"sdk":{"default_table_title":"Nilai tertinggi","language":{"ar":"Bahasa Arab","cs":"Bahasa Ceko","de":"Bahasa Jerman","el":"Bahasa Yunani","en":"Bahasa Inggris","es":"Bahasa Spanyol","fr":"Bahasa Perancis","he":"Bahasa Ibrani","hi":"Bahasa Hindi","id":"Bahasa Indonesia","it":"Bahasa Italia","ja":"Bahasa Jepang","ko":"Bahasa Korea","nl":"Bahasa Belanda","pl":"Bahasa Polandia","pt":"Bahasa Portugis","pt-BR":"Bahasa Portugis Brasil","ro":"Bahasa Romania","ru":"Bahasa Rusia","th":"Bahasa Thailand","tl":"Bahasa Tagalog","tr":"Bahasa Turki","vi-VN":"Bahasa Vietnam","zh":"Bahasa Mandarin"},"login":{"email":"Email","footer1":"Tidak memiliki akun?","footer2":"Buat akun","forgot":"Lupa kata sandi?","password":"Kata sandi","title":"Login"},"playtomic":{"achievements":"Prestasi","alltime":"Semua Waktu","new_account":"Akun Baru","newest":"Terbaru","page":"Halaman %{num}","personal_best":"Pribadi terbaik","seven_days":"7 Hari","thirty_days":"30 Hari"},"register":"Daftar","registration":{"apr":"April","aug":"Agustus","city":"Kota","country":"Negara","dec":"Desember","dob":"Tanggal Lahir","email":"Email","feb":"Februari","female":"Perempuan","first-name":"Nama depan","footer1":"Sudah memiliki akun?","footer2":"Login","footer3":"Menekan tombol selesai menunjukkan bahwa kamu bisa, sudah membaca, dan setuju dengan","jan":"Januari","june":"Juni","language":"Bahasa","last-name":"Nama belakang","male":"Laki-laki","mar":"Maret","may":"Mei","month":"Bulan","nickname":"Nama panggilan","nov":"Nopember","oct":"Oktober","password":"Kata sandi","sep":"September","state":"Provinsi","street":"Alamat jalan","title":"Registrasi","zip":"Kode pos"}}}'
//         )),
//         (e.translations.it = JSON.parse(
//           '{"sdk":{"default_table_title":"Punteggi Alti","language":{"ar":"Arabico","cs":"Ceco","de":"Tedesco","el":"Greco","en":"Inglese","es":"Spagnolo","fr":"Francese","he":"Ebraico","hi":"Hindi","id":"Indonesiano","it":"Italiano","ja":"Giapponese","ko":"Coreano","nl":"Olandese","pl":"Polacco","pt":"Portoghese","pt-BR":"Portoghese brasiliano","ro":"Rumeno","ru":"Russo","th":"Thailandese","tl":"Tagalog","tr":"Turco","vi-VN":"Vietnamita","zh":"Cinese"},"login":{"email":"Email","footer1":"Non avete un account?","footer2":"Create un account","forgot":"Hai dimenticato la password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Risultati","alltime":"I migliori in assoluto","new_account":"Nuovo Account","newest":"I piÃ¹ nuovi","page":"Pagina %{num}","personal_best":"I migliori per te","seven_days":"7 Giorni","thirty_days":"30 Giorni"},"register":"Registrati","registration":{"apr":"Aprile","aug":"Agosto","city":"CittÃ ","country":"Paese","dec":"Dicembre","dob":"Data di Nascita","email":"Email","feb":"Febbraio","female":"Femmina","first-name":"Nome","footer1":"Avete giÃ  un account?","footer2":"Login","footer3":"Cliccando su Fine avrete letto e accettato","jan":"Gennaio","june":"Giugno","language":"Linguaggio","last-name":"Cognome","male":"Maschio","mar":"Marzo","may":"Maggio","month":"Mese","nickname":"Nickname","nov":"Novembre","oct":"Ottobre","password":"Password","sep":"Settembre","state":"Stato o provincia","street":"Indirizzo","title":"Registrazione","zip":"CAP"}}}'
//         )),
//         (e.translations.ja = JSON.parse(
//           '{"sdk":{"default_table_title":"ãƒã‚¤ã‚¹ã‚³ã‚¢","language":{"ar":"ã‚¢ãƒ©ãƒ“ã‚¢èªž","cs":"ãƒã‚§ã‚³èªž","de":"ãƒ‰ã‚¤ãƒ„èªž","el":"ã‚®ãƒªã‚·ãƒ£èªž","en":"è‹±èªž","es":"ã‚¹ãƒšã‚¤ãƒ³èªž","fr":"ãƒ•ãƒ©ãƒ³ã‚¹èªž","he":"ãƒ˜ãƒ–ãƒ©ã‚¤èªž","hi":"ãƒ’ãƒ³ãƒ‡ã‚£ãƒ¼èªž","id":"ã‚¤ãƒ³ãƒ‰ãƒã‚·ã‚¢èªž","it":"ã‚¤ã‚¿ãƒªã‚¢èªž","ja":"æ—¥æœ¬èªž","ko":"éŸ“å›½èªž","nl":"ã‚ªãƒ©ãƒ³ãƒ€èªž","pl":"ãƒãƒ¼ãƒ©ãƒ³ãƒ‰èªž","pt":"ãƒãƒ«ãƒˆã‚¬ãƒ«èªž","pt-BR":"ãƒ–ãƒ©ã‚¸ãƒ«ãƒ»ãƒãƒ«ãƒˆã‚¬ãƒ«èªž","ro":"ãƒ«ãƒ¼ãƒžãƒ‹ã‚¢èªž","ru":"ãƒ­ã‚·ã‚¢èªž","th":"ã‚¿ã‚¤èªž","tl":"ã‚¿ã‚¬ãƒ­ã‚°èªž","tr":"ãƒˆãƒ«ã‚³èªž","vi-VN":"ãƒ™ãƒˆãƒŠãƒ èªž","zh":"ä¸­å›½èªž"},"login":{"email":"ãƒ¡ãƒ¼ãƒ«ã‚¢ãƒ‰ãƒ¬ã‚¹","footer1":"ã‚¢ã‚«ã‚¦ãƒ³ãƒˆã‚’æŒã£ã¦ã„ã¾ã›ã‚“ã‹ï¼Ÿ","footer2":"æ–°è¦ã‚¢ã‚«ã‚¦ãƒ³ãƒˆã‚’ä½œæˆã™ã‚‹","forgot":"ãƒ‘ã‚¹ãƒ¯ãƒ¼ãƒ‰ã‚’ãŠå¿˜ã‚Œã§ã™ã‹ï¼Ÿ","password":"ãƒ‘ã‚¹ãƒ¯ãƒ¼ãƒ‰","title":"ãƒ­ã‚°ã‚¤ãƒ³"},"playtomic":{"achievements":"å®Ÿç¸¾","alltime":"ã™ã¹ã¦ã®æœŸé–“","new_account":"æ–°è¦ã‚¢ã‚«ã‚¦ãƒ³ãƒˆ","newest":"æœ€æ–°","page":"%{num} ãƒšãƒ¼ã‚¸","personal_best":"ãƒ‘ãƒ¼ã‚½ãƒŠãƒ«ãƒ™ã‚¹ãƒˆ","seven_days":"ï¼—æ—¥é–“","thirty_days":"30æ—¥é–“"},"register":"ç™»éŒ²","registration":{"apr":"4æœˆ","aug":"8æœˆ","city":"å¸‚åŒºç”ºæ‘","country":"å›½","dec":"12æœˆ","dob":"ç”Ÿå¹´æœˆæ—¥","email":"ãƒ¡ãƒ¼ãƒ«ã‚¢ãƒ‰ãƒ¬ã‚¹","feb":"2æœˆ","female":"å¥³æ€§","first-name":"å","footer1":"ã‚¢ã‚«ã‚¦ãƒ³ãƒˆã‚’æŒã£ã¦ã„ã¾ã™ã‹ï¼Ÿ","footer2":"ãƒ­ã‚°ã‚¤ãƒ³","footer3":"ã€Œå®Œäº†ã€ãƒœã‚¿ãƒ³ã‚’æŠ¼ã™ã“ã¨ã«ã‚ˆã‚Šã€ã‚ãªãŸã¯ãƒ©ã‚¤ã‚»ãƒ³ã‚¹æ¡é …ãŠã‚ˆã³ãƒ—ãƒ©ã‚¤ãƒã‚·ãƒ¼ãƒãƒªã‚·ãƒ¼ã‚’ç†è§£ã—ã€è¨˜è¼‰ã•ã‚Œã¦ã„ã‚‹ã‚‚ã®ã‚’å¾“ã†ã“ã¨ãŒå¯èƒ½ã§ã€åŒæ„ã™ã‚‹ã‚‚ã®ã¨ã¿ãªã•ã‚Œã¾ã™ã€‚","jan":"1æœˆ","june":"6æœˆ","language":"è¨€èªž","last-name":"å§“","male":"ç”·æ€§","mar":"3æœˆ","may":"5æœˆ","month":"æœˆ","nickname":"ãƒ‹ãƒƒã‚¯ãƒãƒ¼ãƒ ","nov":"11æœˆ","oct":"10æœˆ","password":"ãƒ‘ã‚¹ãƒ¯ãƒ¼ãƒ‰","sep":"9æœˆ","state":"éƒ½é“åºœçœŒ","street":"ä½æ‰€","title":"ç™»éŒ²","zip":"éƒµä¾¿ç•ªå·"}}}'
//         )),
//         (e.translations.ko = JSON.parse(
//           '{"sdk":{"default_table_title":"í•˜ì´ ìŠ¤ì½”ì–´","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"í•­ìƒ","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"ê°œì¸ ìµœê³  ê¸°ë¡","seven_days":"7 Days","thirty_days":"30 Days"},"register":"ê°€ìž…í•˜ê¸°","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.nl = JSON.parse(
//           '{"sdk":{"default_table_title":"Highscores","language":{"ar":"Arabisch","cs":"Tsjechisch","de":"Duits","el":"Grieks","en":"Engels","es":"Spaans","fr":"Frans","he":"Herbreeuws","hi":"Hindi","id":"Indonesian","it":"Italiaans","ja":"Japans","ko":"Koreaans","nl":"Nederlands","pl":"Pools","pt":"Portugees","pt-BR":"Braziliaans Portugees","ro":"Roemeens","ru":"Russisch","th":"Thais","tl":"Tagalog","tr":"Turks","vi-VN":"Vietnamees","zh":"Chinees"},"login":{"email":"E-mail","footer1":"Heb je geen account?","footer2":"Maak een account","forgot":"Wachtwoord vergeten?","password":"Wachtwoord","title":"Inloggen"},"playtomic":{"achievements":"Prestaties","alltime":"All Time","new_account":"Nieuw account","newest":"Nieuwste","page":"Pagina %{num}","personal_best":"Persoonlijk record","seven_days":"7 dagen","thirty_days":"30 dagen"},"register":"Aanmelden","registration":{"apr":"april","aug":"augustus","city":"stad","country":"Land","dec":"december","dob":"Geboortedatum","email":"E-mail","feb":"februari","female":"Vrouwelijk","first-name":"Voornaam","footer1":"Heb je al een account?","footer2":"Login","footer3":"Als u op finish klikt, geeft dit aan dat u in staat bent, hebt gelezen en akkoord gaat met de","jan":"januari","june":"juni","language":"taal","last-name":"Achternaam","male":"Mannelijk","mar":"maart","may":"mei","month":"Maand","nickname":"Bijnaam","nov":"november","oct":"oktober","password":"Wachtwoord","sep":"september","state":"Staat of provincie","street":"adres","title":"Registratie","zip":"Postcode"}}}'
//         )),
//         (e.translations.pl = JSON.parse(
//           '{"sdk":{"default_table_title":"Ranking","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"OgÃ³Å‚em","new_account":"New Account","newest":"Najnowsze","page":"Page %{num}","personal_best":"Osobiste najlepsze","seven_days":"7 dni","thirty_days":"30 dni"},"register":"Zarejestruj","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.pt = JSON.parse(
//           '{"sdk":{"default_table_title":"PontuaÃ§Ãµes MÃ¡ximas","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"Todo o tempo","new_account":"New Account","newest":"Mais recentes","page":"Page %{num}","personal_best":"O seu melhor","seven_days":"7 Dias","thirty_days":"30 Dias"},"register":"Registar-se","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations["pt-BR"] = JSON.parse(
//           '{"sdk":{"default_table_title":"PontuaÃ§Ãµes mais altas","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"All Time","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"Personal best","seven_days":"7 Days","thirty_days":"30 Days"},"register":"Registrar","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.ro = JSON.parse(
//           '{"sdk":{"default_table_title":"Scoruri Mari","language":{"ar":"ArabÄƒ","cs":"CehÄƒ","de":"GermanÄƒ","el":"GreacÄƒ","en":"EnglezÄƒ","es":"SpaniolÄƒ","fr":"FrancezÄƒ","he":"EbraicÄƒ","hi":"Hindi","id":"IndonezianÄƒ","it":"ItalianÄƒ","ja":"JaponezÄƒ","ko":"CoreanÄƒ","nl":"OlandezÄƒ","pl":"PolonezÄƒ","pt":"PortughezÄƒ","pt-BR":"PortughezÄƒ BrazilianÄƒ","ro":"RomÃ¢nÄƒ","ru":"RusÄƒ","th":"ThailandezÄƒ","tl":"Tagalog","tr":"TurcÄƒ","vi-VN":"VietnamezÄƒ","zh":"ChinezÄƒ"},"login":{"email":"Email","footer1":"Nu ai un cont?","footer2":"CreeazÄƒ un cont","forgot":"Ai uitat parola?","password":"ParolÄƒ","title":"Autentificare"},"playtomic":{"achievements":"RealizÄƒri","alltime":"Tot Timpul","new_account":"Cont nou","newest":"Cele mai noi","page":"PaginÄƒ %{num}","personal_best":"Record personal","seven_days":"7 Zile","thirty_days":"30 Zile"},"register":"ÃŽnregistreazÄƒ-te","registration":{"apr":"Aprilie","aug":"August","city":"OraÈ™","country":"ÈšarÄƒ","dec":"Decembrie","dob":"Data NaÈ™terii","email":"Email","feb":"Februarie","female":"Feminin","first-name":"Prenume","footer1":"Ai deja un cont?","footer2":"Autentificare","footer3":"FÄƒcÃ¢nd click pe terminare indicÄƒ cÄƒ eÈ™ti capabil, ai citit, È™i fost de acord cu","jan":"Ianuarie","june":"Iunie","language":"LimbÄƒ","last-name":"Nume","male":"Masculin","mar":"Martie","may":"Mai","month":"LunÄƒ","nickname":"PoreclÄƒ","nov":"Noiembrie","oct":"Octombrie","password":"ParolÄƒ","sep":"Septembrie","state":"Stat sau provincie","street":"AdresÄƒ stradÄƒ","title":"ÃŽnregistrare","zip":"Cod poÈ™tal"}}}'
//         )),
//         (e.translations.ru = JSON.parse(
//           '{"sdk":{"default_table_title":"Ð ÐµÐºÐ¾Ñ€Ð´Ñ‹","language":{"ar":"ÐÑ€Ð°Ð±ÑÐºÐ¸Ð¹","cs":"Ð§ÐµÑˆÑÐºÐ¸Ð¹","de":"ÐÐµÐ¼ÐµÑ†ÐºÐ¸Ð¹","el":"Ð“Ñ€ÐµÑ‡ÐµÑÐºÐ¸Ð¹","en":"ÐÐ½Ð³Ð»Ð¸Ð¹ÑÐºÐ¸Ð¹","es":"Ð˜ÑÐ¿Ð°Ð½ÑÐºÐ¸Ð¹","fr":"Ð¤Ñ€Ð°Ð½Ñ†ÑƒÐ·ÑÐºÐ¸Ð¹","he":"Ð˜Ð²Ñ€Ð¸Ñ‚","hi":"Ð¥Ð¸Ð½Ð´Ð¸","id":"Ð˜Ð½Ð´Ð¾Ð½ÐµÐ·Ð¸Ð¹ÑÐºÐ¸Ð¹","it":"Ð˜Ñ‚Ð°Ð»ÑŒÑÐ½ÑÐºÐ¸Ð¹","ja":"Ð¯Ð¿Ð¾Ð½ÑÐºÐ¸Ð¹","ko":"ÐšÐ¾Ñ€ÐµÐ¹ÑÐºÐ¸Ð¹","nl":"ÐÐ¸Ð´ÐµÑ€Ð»Ð°Ð½Ð´ÑÐºÐ¸Ð¹","pl":"ÐŸÐ¾Ð»ÑŒÑÐºÐ¸Ð¹","pt":"ÐŸÐ¾Ñ€Ñ‚ÑƒÐ³Ð°Ð»ÑŒÑÐºÐ¸Ð¹","pt-BR":"Ð‘Ñ€Ð°Ð·Ð¸Ð»ÑŒÑÐºÐ¸Ð¹ Ð¿Ð¾Ñ€Ñ‚ÑƒÐ³Ð°Ð»ÑŒÑÐºÐ¸Ð¹","ro":"Ð ÑƒÐ¼Ñ‹Ð½ÑÐºÐ¸Ð¹","ru":"Ð ÑƒÑÑÐºÐ¸Ð¹","th":"Ð¢Ð°Ð¹ÑÐºÐ¸Ð¹","tl":"Ð¢Ð°Ð³Ð°Ð»ÑŒÑÐºÐ¸Ð¹","tr":"Ð¢ÑƒÑ€ÐµÑ†ÐºÐ¸Ð¹","vi-VN":"Ð’ÑŒÐµÑ‚Ð½Ð°Ð¼ÑÐºÐ¸Ð¹","zh":"ÐšÐ¸Ñ‚Ð°Ð¹ÑÐºÐ¸Ð¹"},"login":{"email":"ÐÐ´Ñ€ÐµÑ ÑÐ». Ð¿Ð¾Ñ‡Ñ‚Ñ‹","footer1":"Ð£ Ð²Ð°Ñ Ð½ÐµÑ‚ ÑƒÑ‡ÐµÑ‚Ð½Ð¾Ð¹ Ð·Ð°Ð¿Ð¸ÑÐ¸?","footer2":"Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ ÑƒÑ‡ÐµÑ‚Ð½ÑƒÑŽ Ð·Ð°Ð¿Ð¸ÑÑŒ","forgot":"Ð—Ð°Ð±Ñ‹Ð»Ð¸ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ?","password":"ÐŸÐ°Ñ€Ð¾Ð»ÑŒ","title":"Ð’Ð¾Ð¹Ñ‚Ð¸"},"playtomic":{"achievements":"Ð”Ð¾ÑÑ‚Ð¸Ð¶ÐµÐ½Ð¸Ñ","alltime":"Ð—Ð° Ð²ÑÐµ Ð²Ñ€ÐµÐ¼Ñ","new_account":"ÐÐ¾Ð²Ñ‹Ð¹ Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚","newest":"ÐÐ¾Ð²ÐµÐ¹ÑˆÐµÐµ","page":"Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð° %{num}","personal_best":"Ð›Ð¸Ñ‡Ð½Ñ‹Ðµ Ñ€ÐµÐºÐ¾Ñ€Ð´Ñ‹","seven_days":"7 Ð´Ð½ÐµÐ¹","thirty_days":"30 Ð´Ð½ÐµÐ¹"},"register":"Ð—Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒÑÑ","registration":{"apr":"ÐÐ¿Ñ€ÐµÐ»ÑŒ","aug":"ÐÐ²Ð³ÑƒÑÑ‚","city":"Ð“Ð¾Ñ€Ð¾Ð´","country":"Ð¡Ñ‚Ñ€Ð°Ð½Ð°","dec":"Ð”ÐµÐºÐ°Ð±Ñ€ÑŒ","dob":"Ð”Ð°Ñ‚Ð° Ñ€Ð¾Ð¶Ð´ÐµÐ½Ð¸Ñ","email":"ÐÐ´Ñ€ÐµÑ ÑÐ». Ð¿Ð¾Ñ‡Ñ‚Ñ‹","feb":"Ð¤ÐµÐ²Ñ€Ð°Ð»ÑŒ","female":"Ð–ÐµÐ½Ñ‰Ð¸Ð½Ð°","first-name":"Ð˜Ð¼Ñ","footer1":"Ð£Ð¶Ðµ ÐµÑÑ‚ÑŒ ÑƒÑ‡ÐµÑ‚Ð½Ð°Ñ Ð·Ð°Ð¿Ð¸ÑÑŒ?","footer2":"Ð’Ð¾Ð¹Ñ‚Ð¸","footer3":"ÐÐ°Ð¶Ð°Ñ‚Ð¸Ðµ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ Â«Ð“Ð¾Ñ‚Ð¾Ð²Ð¾Â» Ð¾Ð·Ð½Ð°Ñ‡Ð°ÐµÑ‚, Ñ‡Ñ‚Ð¾ Ð²Ñ‹ Ð³Ð¾Ñ‚Ð¾Ð²Ñ‹ ÑÐ¾Ð±Ð»ÑŽÐ´Ð°Ñ‚ÑŒ, Ð¿Ñ€Ð¾Ñ‡Ð¸Ñ‚Ð°Ð»Ð¸ Ð¸ ÑÐ¾Ð³Ð»Ð°ÑÐ½Ñ‹ Ñ","jan":"Ð¯Ð½Ð²Ð°Ñ€ÑŒ","june":"Ð˜ÑŽÐ½ÑŒ","language":"Ð¯Ð·Ñ‹Ðº","last-name":"Ð¤Ð°Ð¼Ð¸Ð»Ð¸Ñ","male":"ÐœÑƒÐ¶Ñ‡Ð¸Ð½Ð°","mar":"ÐœÐ°Ñ€Ñ‚","may":"ÐœÐ°Ð¹","month":"ÐœÐµÑÑÑ†","nickname":"ÐÐ¸ÐºÐ½ÐµÐ¹Ð¼","nov":"ÐÐ¾ÑÐ±Ñ€ÑŒ","oct":"ÐžÐºÑ‚ÑÐ±Ñ€ÑŒ","password":"ÐŸÐ°Ñ€Ð¾Ð»ÑŒ","sep":"Ð¡ÐµÐ½Ñ‚ÑÐ±Ñ€ÑŒ","state":"Ð¨Ñ‚Ð°Ñ‚ Ð¸Ð»Ð¸ Ð¿Ñ€Ð¾Ð²Ð¸Ð½Ñ†Ð¸Ñ","street":"ÐÐ´Ñ€ÐµÑ","title":"Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ñ","zip":"ÐŸÐ¾Ñ‡Ñ‚Ð¾Ð²Ñ‹Ð¹ Ð¸Ð½Ð´ÐµÐºÑ"}}}'
//         )),
//         (e.translations.th = JSON.parse(
//           '{"sdk":{"default_table_title":"à¸„à¸°à¹à¸™à¸™à¸ªà¸¹à¸‡à¸ªà¸¸à¸”","language":{"ar":"à¸­à¸²à¸«à¸£à¸±à¸š","cs":"à¹€à¸Šà¹‡à¸","de":"à¹€à¸¢à¸­à¸£à¸¡à¸±à¸™","el":"à¸à¸£à¸µà¸","en":"à¸­à¸±à¸‡à¸à¸¤à¸©","es":"à¸ªà¹€à¸›à¸™","fr":"à¸à¸£à¸±à¹ˆà¸‡à¹€à¸¨à¸ª","he":"à¸®à¸´à¸šà¸£à¸¹","hi":"à¸®à¸´à¸™à¸”à¸¹","id":"à¸­à¸´à¸™à¹‚à¸”à¸™à¸´à¹€à¸‹à¸µà¸¢","it":"à¸­à¸´à¸•à¸²à¹€à¸¥à¸µà¸¢à¸™","ja":"à¸à¸µà¹ˆà¸›à¸¸à¹ˆà¸™","ko":"à¹€à¸à¸²à¸«à¸¥à¸µ","nl":"à¹€à¸™à¹€à¸˜à¸­à¸£à¹Œà¹à¸¥à¸™à¸”à¹Œ","pl":"à¹‚à¸›à¹à¸¥à¸™à¸”à¹Œ","pt":"à¹‚à¸›à¸£à¸•à¸¸à¹€à¸à¸ª","pt-BR":"à¸šà¸£à¸²à¸‹à¸´à¸¥ à¹‚à¸›à¸£à¸•à¸¸à¹€à¸à¸ª","ro":"à¹‚à¸£à¸¡à¸²à¹€à¸™à¸µà¸¢","ru":"à¸£à¸±à¸ªà¹€à¸‹à¸µà¸¢","th":"à¹„à¸—à¸¢","tl":"à¸•à¸²à¸à¸²à¸¥à¹‡à¸­à¸","tr":"à¸•à¸¸à¸£à¸à¸µ","vi-VN":"à¹€à¸§à¸µà¸¢à¸”à¸™à¸²à¸¡","zh":"à¸ˆà¸µà¸™"},"login":{"email":"à¸­à¸µà¹€à¸¡à¸¥","footer1":"à¹„à¸¡à¹ˆà¸¡à¸µà¸šà¸±à¸à¸Šà¸µ?","footer2":"à¸ªà¸£à¹‰à¸²à¸‡à¸šà¸±à¸à¸Šà¸µ","forgot":"à¸¥à¸·à¸¡à¸£à¸«à¸±à¸ªà¸œà¹ˆà¸²à¸™?","password":"à¸£à¸«à¸±à¸ªà¸œà¹ˆà¸²à¸™","title":"à¹€à¸‚à¹‰à¸²à¸ªà¸¹à¹ˆà¸£à¸°à¸šà¸š"},"playtomic":{"achievements":"à¸„à¸§à¸²à¸¡à¸ªà¸³à¹€à¸£à¹‡à¸ˆ","alltime":"à¸•à¸¥à¸­à¸”à¹€à¸§à¸¥à¸²","new_account":"à¸šà¸±à¸à¸Šà¸µà¹ƒà¸«à¸¡à¹ˆ","newest":"à¹ƒà¸«à¸¡à¹ˆà¸¥à¹ˆà¸²à¸ªà¸¸à¸”","page":"à¸«à¸™à¹‰à¸² %{num}","personal_best":"à¸ªà¹ˆà¸§à¸™à¸•à¸±à¸§à¸”à¸µà¸—à¸µà¹ˆà¸ªà¸¸à¸”","seven_days":"7 à¸§à¸±à¸™","thirty_days":"30 à¸§à¸±à¸™"},"register":"à¸¥à¸‡à¸—à¸°à¹€à¸šà¸µà¸¢à¸™","registration":{"apr":"à¹€à¸¡à¸©à¸²à¸¢à¸™","aug":"à¸ªà¸´à¸‡à¸«à¸²à¸„à¸¡","city":"à¹€à¸¡à¸·à¸­à¸‡","country":"à¸›à¸£à¸°à¹€à¸—à¸¨","dec":"à¸˜à¸±à¸™à¸§à¸²à¸„à¸¡","dob":"à¸§à¸±à¸™à¹€à¸à¸´à¸”","email":"à¸­à¸µà¹€à¸¡à¸¥","feb":"à¸à¸¸à¸¡à¸ à¸²à¸žà¸±à¸™à¸˜à¹Œ","female":"à¹€à¸žà¸¨à¸«à¸à¸´à¸‡","first-name":"à¸Šà¸·à¹ˆà¸­à¸ˆà¸£à¸´à¸‡","footer1":"à¸¡à¸µà¸šà¸±à¸à¸Šà¸µà¸­à¸¢à¸¹à¹ˆà¹à¸¥à¹‰à¸§?","footer2":"à¹€à¸‚à¹‰à¸²à¸ªà¸¹à¹ˆà¸£à¸°à¸šà¸š","footer3":"à¸à¸²à¸£à¸„à¸¥à¸´à¸à¹€à¸ªà¸£à¹‡à¸ˆà¸ªà¸´à¹‰à¸™à¹à¸ªà¸”à¸‡à¸§à¹ˆà¸²à¸„à¸¸à¸“à¸ªà¸²à¸¡à¸²à¸£à¸– à¹„à¸”à¹‰à¸­à¹ˆà¸²à¸™ à¹à¸¥à¸°à¸¢à¸­à¸¡à¸£à¸±à¸š","jan":"à¸¡à¸à¸£à¸²à¸„à¸¡","june":"à¸¡à¸´à¸–à¸¸à¸™à¸²à¸¢à¸™","language":"à¸ à¸²à¸©à¸²","last-name":"à¸™à¸²à¸¡à¸ªà¸à¸¸à¸¥","male":"à¹€à¸žà¸¨à¸Šà¸²à¸¢","mar":"à¸¡à¸µà¸™à¸²à¸„à¸¡","may":"à¸žà¸¤à¸©à¸ à¸²à¸„à¸¡","month":"à¹€à¸”à¸·à¸­à¸™","nickname":"à¸Šà¸·à¹ˆà¸­à¹€à¸¥à¹ˆà¸™","nov":"à¸žà¸¤à¸¨à¸ˆà¸´à¸à¸²à¸¢à¸™","oct":"à¸•à¸¸à¸¥à¸²à¸„à¸¡","password":"à¸£à¸«à¸±à¸ªà¸œà¹ˆà¸²à¸™","sep":"à¸à¸±à¸™à¸¢à¸²à¸¢à¸™","state":"à¸£à¸±à¸à¸«à¸£à¸·à¸­à¸ˆà¸±à¸‡à¸«à¸§à¸±à¸”","street":"à¸—à¸µà¹ˆà¸­à¸¢à¸¹à¹ˆà¸–à¸™à¸™","title":"à¸à¸²à¸£à¸¥à¸‡à¸—à¸°à¹€à¸šà¸µà¸¢à¸™","zip":"à¸£à¸«à¸±à¸ªà¹„à¸›à¸£à¸©à¸“à¸µà¸¢à¹Œ"}}}'
//         )),
//         (e.translations.tl = JSON.parse(
//           '{"sdk":{"default_table_title":"Mga pinakamatataas na Iskor","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"Mga Pinakasikat","new_account":"New Account","newest":"Pinakabago","page":"Page %{num}","personal_best":"Ang aking pinakamagaling","seven_days":"7 Araw","thirty_days":"30 Araw"},"register":"Magrehistro","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         (e.translations.tr = JSON.parse(
//           '{"sdk":{"default_table_title":"YÃ¼ksek Puanlar","language":{"ar":"ArapÃ§a","cs":"Ã‡ekÃ§e","de":"Almanca","el":"Yunanca","en":"Ä°ngilizce","es":"Ä°spanyolca","fr":"FransÄ±zca","he":"Ä°branice","hi":"HintÃ§e","id":"Endonezce","it":"Ä°talyanca","ja":"Japonca","ko":"Korece","nl":"Hollandaca","pl":"LehÃ§e","pt":"Portekizce","pt-BR":"Brezilya Portekizcesi","ro":"Romence","ru":"RusÃ§a","th":"Tayca","tl":"Tagalog","tr":"TÃ¼rkÃ§e","vi-VN":"Vietnamca","zh":"Ã‡ince"},"login":{"email":"E-mail","footer1":"Bir hesabÄ±nÄ±z yok mu?","footer2":"Bir hesap oluÅŸturun","forgot":"ParolayÄ± unuttunuz mu?","password":"Parola","title":"Oturum AÃ§"},"playtomic":{"achievements":"BaÅŸarÄ±mlar","alltime":"SÃ¼rekli","new_account":"Yeni Hesap","newest":"En Yeni","page":"Sayfa %{num}","personal_best":"En iyi kiÅŸisel rekor","seven_days":"7 GÃ¼n","thirty_days":"30 GÃ¼n"},"register":"KayÄ±t","registration":{"apr":"Nisan","aug":"AÄŸustos","city":"Åžehir","country":"Ãœlke","dec":"AralÄ±k","dob":"DoÄŸum Tarihi","email":"E-posta","feb":"Åžubat","female":"KadÄ±n","first-name":"AdÄ±","footer1":"Zaten bir hesabÄ±nÄ±z var mÄ±?","footer2":"Oturum AÃ§","footer3":"Bitir\'i tÄ±kladÄ±ÄŸÄ±nÄ±zda, ÅŸunu okuduÄŸunuz ve kabul ettiÄŸiniz anlamÄ±na gelir","jan":"Ocak","june":"Haziran","language":"Dil","last-name":"SoyadÄ±","male":"Erkek","mar":"Mart","may":"MayÄ±s","month":"Ay","nickname":"Takma Ad","nov":"KasÄ±m","oct":"Ekim","password":"Parola","sep":"EylÃ¼l","state":"Eyalet veya Ä°l","street":"Adres","title":"KayÄ±t","zip":"Posta kodu"}}}'
//         )),
//         (e.translations["vi-VN"] = JSON.parse(
//           '{"sdk":{"default_table_title":"Äiá»ƒm cao","language":{"ar":"Tiáº¿ng áº¢ ráº­p","cs":"Tiáº¿ng SÃ©c","de":"Tiáº¿ng Äá»©c","el":"Tiáº¿ng Hi Láº¡p","en":"Tiáº¿ng Anh","es":"Tiáº¿ng TÃ¢y Ban Nha","fr":"Tiáº¿ng PhÃ¡p","he":"Tiáº¿ng Hebrew","hi":"Tiáº¿ng Hindi","id":"Tiáº¿ng In Ä‘Ã´","it":"Tiáº¿ng Ã","ja":"Tiáº¿ng Nháº­t","ko":"Tiáº¿ng HÃ n","nl":"Tiáº¿ng HÃ  Lan","pl":"Tiáº¿ng Ba Lan","pt":"Tiáº¿ng Bá»“ ÄÃ o Nha","pt-BR":"Tiá»ng Bá»“ ÄÃ o Nha Brazil","ro":"Tiáº¿ng Rumani","ru":"Tiáº¿ng Nga","th":"Tiáº¿ng ThÃ¡i","tl":"Tiáº¿ng Tagalog","tr":"Tiáº¿ng Thá»• NhÄ© Ká»³","vi-VN":"Tiáº¿ng Viá»‡t","zh":"Tiáº¿ng Trung Quá»‘c"},"login":{"email":"ThÆ° Ä‘iá»‡n tá»­","footer1":"Báº¡n khÃ´ng cÃ³ tÃ i khoáº£n Ä‘Ãºng khÃ´ng?","footer2":"Táº¡o má»™t tÃ i khoáº£n","forgot":"QuÃªn máº­t kháº©u?","password":"Máº­t kháº©u","title":"ÄÄƒng nháº­p"},"playtomic":{"achievements":"ThÃ nh tÃ­ch","alltime":"Táº¥t cáº£ má»i thá»i gian","new_account":"TÃ i khoáº£n má»›i","newest":"Má»›i nháº¥t","page":"Trang %{num}","personal_best":"CÃ¡ nhÃ¢n tá»‘t nháº¥t","seven_days":"7 ngÃ y","thirty_days":"30 ngÃ y"},"register":"ÄÄƒng kÃ½","registration":{"apr":"ThÃ¡ng TÆ°","aug":"ThÃ¡ng TÃ¡m","city":"ThÃ nh phá»‘","country":"NÆ°á»›c","dec":"ThÃ¡ng MÆ°á»i hai","dob":"NgÃ y sinh","email":"ThÆ° Ä‘iá»‡n tá»­","feb":"ThÃ¡ng Hai","female":"Ná»¯","first-name":"TÃªn","footer1":"Báº¡n Ä‘Ã£ cÃ³ tÃ i khoáº£n rá»“i pháº£i khÃ´ng?","footer2":"ÄÄƒng nháº­p","footer3":"Nháº¥p vÃ o káº¿t thÃºc Ä‘á»ƒ cho biáº¿t lÃ  báº¡n Ä‘Ã£ cÃ³ thá»ƒ Ä‘Ã£ Ä‘á»c vÃ  Ä‘á»“ng Ã½ vá»›i","jan":"ThÃ¡ng Má»™t","june":"ThÃ¡ng SÃ¡u","language":"NgÃ´n ngá»¯","last-name":"Há»","male":"Nam","mar":"ThÃ¡ng Ba","may":"ThÃ¡ng NÄƒm","month":"ThÃ¡ng","nickname":"Biá»‡t danh","nov":"ThÃ¡ng MÆ°á»i má»™t","oct":"ThÃ¡ng MÆ°á»i","password":"Máº­t kháº©u","sep":"ThÃ¡ng ChÃ­n","state":"Bang hoáº·c tá»‰nh","street":"Äá»‹a chá»‰ Ä‘Æ°á»ng","title":"ÄÄƒng kÃ½","zip":"MÃ£ bÆ°u chÃ­nh"}}}'
//         )),
//         (e.translations.zh = JSON.parse(
//           '{"sdk":{"default_table_title":"é«˜åˆ†æ¦œ","language":{"ar":"Arabic","cs":"Czech","de":"German","el":"Greek","en":"English","es":"Spanish","fr":"French","he":"Hebrew","hi":"Hindi","id":"Indonesian","it":"Italian","ja":"Japanese","ko":"Korean","nl":"Dutch","pl":"Polish","pt":"Portuguese","pt-BR":"Brazilian Portuguese","ro":"Romanian","ru":"Russian","th":"Thai","tl":"Tagalog","tr":"Turkish","vi-VN":"Vietnamese","zh":"Chinese"},"login":{"email":"Email","footer1":"Don\'t have an account?","footer2":"Create an account","forgot":"Forgot password?","password":"Password","title":"Login"},"playtomic":{"achievements":"Achievements","alltime":"æ€»æ˜¯","new_account":"New Account","newest":"Newest","page":"Page %{num}","personal_best":"ä¸ªäººæœ€ä½³","seven_days":"7 Days","thirty_days":"30 Days"},"register":"æ³¨å†Œ","registration":{"apr":"April","aug":"August","city":"City","country":"Country","dec":"December","dob":"Date of Birth","email":"Email","feb":"February","female":"Female","first-name":"First name","footer1":"Already have an account?","footer2":"Login","footer3":"Clicking finish indicates you are able, have read, and agree to the","jan":"January","june":"June","language":"Language","last-name":"Last name","male":"Male","mar":"March","may":"May","month":"Month","nickname":"Nickname","nov":"November","oct":"October","password":"Password","sep":"September","state":"State or province","street":"Street address","title":"Registration","zip":"Zipcode"}}}'
//         )),
//         e
//       );
//     }),
...
//             destroy: function (e) {
//               h.iframe &&
//                 (n.removeEventListener(h.mask, "click", h.destroy),
...
//                 h.mask && (document.body.removeChild(h.mask), (h.mask = null)),
//                 (h.iframe = null),
//                 (h.loaded = !1),
//                 e ||
//                   ((h.loadedCallback = null),
//                   h.unloadedCallback && h.unloadedCallback(),
//                   (h.unloadedCallback = null),
//                   window.focus()));
//             },
//             reload: function () {
//               h.destroy(!0), h.create(d, p, f);
//             },
...
//                 n.setAttribute(
//                   "style",
//                   "position: absolute; z-index: 10000; border: 0;"
//                 ),
//                 (n.title = "sdk menu"),
//                 (n.scrolling = "no"),
...
//                   r.setAttribute(
//                     "style",
//                     "position: absolute; z-index: 9999; border: 0; top: 0; left: 0;"
//                   ),
...
//                 o = (r - h.width) / 2,
//                 s = (a - h.height) / 2;
//               (h.iframe.style.left = o + "px"), (h.iframe.style.top = s + "px");
//             },
//             resize: function () {
...
//                 i = t.width;
//               i > window.innerWidth &&
//                 ((i = window.innerWidth), (e.style.width = window.innerWidth)),
//                 (h.width = i),
//                 (h.height = n),
...
//               -1 != e.target.className.indexOf("locale-click") &&
//                 (h.document().getElementById("locale-dropdown").style.display =
//                   "block"),
//                 -1 != e.target.className.indexOf("locale-language") &&
//                   ((h
//                     .document()
//                     .getElementById("locale-dropdown").style.display = "none"),
//                   (l = e.target.id),
//                   "undefined" != typeof Storage &&
//                     localStorage.setItem("locale", l),
//                   (o.locale = "pt-BR" == l || "vi-VN" == l ? l : l.slice(0, 2)),
//                   h.reload()),
//                 "locale-backdrop" == e.target.id &&
//                   (h
//                     .document()
//                     .getElementById("locale-dropdown").style.display = "none");
//             },
...
//                 r.embedded
//                   ? a
//                   : (i.addEventListener(a.mask, "click", function () {
...
//             },
//             destroyAll: function () {
//               for (var e in this.__dialogs) this.__dialogs[e].destroy();
//               (this.__dialogs = {}), s.destroy();
//             },
...
//                   '" name="' +
//                   l.id +
//                   '" style="border:none; overflowX:hidden; visibility:hidden;" src="javascript:false;" title="sdk menu"></iframe>';
//                 l.replaceContent(
//                   '<iframe src="javascript:false" frameborder="0" scrolling="no" title="sdk menu" style="height:1px; display:none; visibility:hidden;"></iframe>'
//                 ),
//                   (a._sdk = l.id),
//                   setTimeout(function () {
//                     l.replaceContent(u);
...
//                   i.setAttribute(
//                     "style",
//                     "border:none; overflowX:hidden; visibility:visible;"
//                   );
//                   var r = document.body,
...
//               var p = this;
//               return (
//                 i.addEventListener(window, "resize", function () {
//                   p.centerDialog(l);
//                   var e = 1;
...
//                 this.sizeMask(e, a, o), this.sizeFrame(e, a, o);
//                 var s = (a - e.width()) / 2,
//                   l = (o - e.height()) / 2;
//                 e.setLeft(s), e.setTop(l);
//               }
//             },
...
//             t.inform("dialog.closed", null), l.destroy(t.id);
//           }),
//           l
//         );
//       }
...
//               console.log(arguments[e]), this.history.push(arguments[e]);
//         },
//         addCall: function () {
//           t.push(e.local("unix")),
//             t.length >= 50 &&
//               this.log("WANRING: Too many API calls are being made to id.net");
...
//         if (
//           ((r =
//             "string" == typeof r ? { uri: r } : JSON.parse(JSON.stringify(r))),
//           (r.onResponse = s),
//           r.verbose && (e.log = i()),
//           r.url && ((r.uri = r.url), delete r.url),
//           !r.uri && "" !== r.uri)
//         )
...
//           u++
//         )
//           if (r[l[u]]) throw new Error("options." + l[u] + " is not supported");
//         if (
//           ((r.callback = a),
...
//           "boolean" != typeof r.json
//             ? (r.body = JSON.stringify(r.json))
//             : "string" != typeof r.body && (r.body = JSON.stringify(r.body)));
//         var c = function (e) {
//           var t = [];
//           for (var n in e)
//             e.hasOwnProperty(n) &&
...
//           if ("POST" === r.method) {
//             var f = (
//               r.encoding || "application/x-www-form-urlencoded"
//             ).toLowerCase();
//             switch (((r.headers["content-type"] = f), f)) {
...
//         }
//         return (
//           (r.onResponse = r.onResponse || n),
//           r.onResponse === !0 && ((r.onResponse = a), (r.callback = n)),
//           !r.headers.authorization &&
//             r.auth &&
//             (r.headers.authorization =
//               "Basic " + o(r.auth.username + ":" + r.auth.password)),
//           t(r)
//         );
//       }
//       function t(t) {
...
//             e.log.error("Timeout", { id: c._id, milliseconds: t.timeout }),
//             t.callback(n, c)
//           );
//         }
//         function i() {
...
//           } else c.readyState === s.HEADERS_RECEIVED ? r() : c.readyState === s.LOADING ? (r(), o()) : c.readyState === s.DONE && (r(), o(), l());
//         }
//         function r() {
//           if (!g.response) {
//             if (
//               ((g.response = !0),
//               e.log.debug("Got response", { id: c.id, status: c.status }),
...
//           g.loading ||
//             ((g.loading = !0),
//             e.log.debug("Response body loading", { id: c.id }));
//         }
//         function l() {
//           if (!g.end) {
//             if (
//               ((g.end = !0),
//               e.log.debug("Request done", { id: c.id }),
...
//         ) {
//           var h = new Error(
//             "Browser does not support cross-origin request: " + t.uri
//           );
//           return (h.cors = "unsupported"), t.callback(h, c);
//         }
...
//         function n(n, i) {
//           return (
//             "object" == typeof i && (n += " " + JSON.stringify(i)),
//             e[t].call(e, n)
//           );
//         }
//         return n;
...
//             "string" == typeof t
//               ? (t = { method: n, uri: t })
//               : ((t = JSON.parse(JSON.stringify(t))), (t.method = n));
...
//                 var n,
//                   i = a.getDialog(e);
//                 i && ((n = JSON.parse(t)), i.call(n)), a.destroy(e);
//               },
//               setSize: function (e, t, n) {
//                 (dialog = a.getDialog(e)), dialog.resize(t, n);
//               },
//             },
//           },
//           !0
...
//             var l =
//                 t.root_url + "/api/v1/json" + (e.match(/^\//) ? e : "/" + e),
//               c = i.getOAuthToken();
//             c
//               ? (s.addCall(),
...
//               u
//                 .getXdHandler()
//                 .api({ method: i, url: url, data: r || {} }, n(a), n(a));
//           },
//           api2: function (e, n, r, a) {
//             var o =
//                 t.root_url + "/api/v1/json" + (e.match(/^\//) ? e : "/" + e),
//               u = { url: o, method: n, json: r || {} },
//               c = i.getOAuthToken();
//             c &&
//               ((u.headers = { Authorization: "Bearer " + c }),
//               s.addCall(),
...
//     define(
//       "distribution_block",
//       ["require", "utils/domain", "sdk/api"],
//       function (e) {
//         var t = e("utils/domain"),
//           n = e("sdk/api"),
//           i = t.getDomain();
//         -1 == i.search("localhost") &&
//           n.apiOpen("protection-lists", "GET", null, function (e) {
//             if (e.hasOwnProperty("distribution_block_urls")) {
//               if (e.hasOwnProperty("distribution_exceptions_urls"))
//                 for (
//                   var t = e.distribution_exceptions_urls, n = 0;
//                   n < t.length;
//                   n++
//                 )
//                   if (-1 != i.search(t[n])) return;
//               for (var r = e.distribution_block_urls, n = 0; n < r.length; n++)
//                 if (-1 != i.search(r[n]))
//                   throw (
//                     ((document.body.innerHTML = ""),
//                     new Error(
//                       "Distribution blocked, please contact y8.com team."
//                     ))
//                   );
//             }
//           });
...
//       ],
//       function (e) {
//         var t = (e("utils/constants"), e("runtime")),
//           n = e("sdk/api"),
//           i = e("event"),
//           r = e("logger"),
//           a = e("utils/cookies");
...
//             if (o)
//               try {
//                 (o = JSON.parse(o)), (e.get = o), i.fire("options");
//               } catch (s) {
//                 r.log("options cache failed", s);
//               }
//             else
//               n.apiOpen(
//                 "client_options/" + t.getAppId(),
//                 "GET",
//                 null,
//                 function (n) {
//                   n.success
...
//           },
//           reset: function () {
//             (this.get = {}), a.setCookie("co" + t.__options.appId, "", -1);
//           },
//         };
//       }
//     ),
...
//             },
//             reset: function () {
//               (c = !1), s.setCookie(n.__options.appId, "", -1);
//             },
//             init: function (e) {
//               f.ieVersion() > 0 && f.ieVersion() < 10
//                 ? f.trackWithPixel("play")
//                 : f.trackWithCORS(e);
//             },
...
//               if (!c) {
//                 "play" != e.event || d
//                   ? "play" == e.event && d && o.log("play event already sent")
//                   : (d = !0);
//                 var n = function (e) {
//                     try {
//                       e = JSON.parse(e);
...
//                       .getXdHandler()
//                       .api(
//                         { method: "POST", url: t.analytics_url, data: e },
//                         n,
//                         i
//                       );
//                 });
...
//                     }
//                     e(
//                       t && t.hasOwnProperty("uuid") && t.uuid
//                         ? t.uuid
//                         : s.getCookie("uuid")
//                     );
//                   },
...
//       function (e) {
//         var t = e("underscore"),
//           n = (e("utils/uri_helper"), e("utils/constants")),
//           i = e("utils/wrapper"),
//           r = e("sdk/api"),
//           a = e("runtime"),
//           o = (e("dialog"), e("sdk/ui")),
...
//                 o &&
//                   o.authResponse &&
//                   "register" == o.authResponse.event_action &&
//                   l.tracker({
//                     event: "reg",
...
//                     "top" in window &&
//                     (top.postMessage("idnetSilentLogin", "*"), (d = !0))),
...
//               (e = n.root_url + "/widgets/" + (e || "login")), (r = r || {});
//               var u, d;
...
//               var p = o.createIframeDialog(
//                 i(f(this.storeLoginResponse, s, e)),
//                 l,
//                 e,
//                 d
//               );
...
//               (e = e || {}), (e.register = !0), h.redirectToOauth(e);
//             },
//             redirectToOauthLogin: function (e) {
//               (e = e || {}), (e.register = !1), h.redirectToOauth(e);
//             },
...
//                     _sdk: 1,
//                     response_type:
//                       o.response_type || a.getDefaultResponseType(),
//                     client_id: a.getAppId(),
//                   },
//                 },
//                 i(f(this.storeLoginResponse, e, "login", !1)),
//                 i(t)
//               );
//             },
//           };
...
//         : "function" == typeof define &&
//           define.amd &&
//           define("utils/jquery-amd", ["require", "module"], function (e, n) {
...
//         if (((r.text = e), n)) for (i in wt) n[i] && (r[i] = n[i]);
...
//       function o(e, t, n) {
//         return yt(t)
//           ? xt.grep(e, function (e, i) {
//               return !!t.call(e, i, e) !== n;
//             })
//           : t.nodeType
//           ? xt.grep(e, function (e) {
//               return (e === t) !== n;
//             })
//           : "string" != typeof t
//           ? xt.grep(e, function (e) {
...
//         var t = {};
//         return (
//           xt.each(e.match(Mt) || [], function (e, n) {
//             t[n] = !0;
//           }),
//           t
//         );
...
//           if (
//             ((i = "data-" + t.replace(Jt, "-$&").toLowerCase()),
//             (n = e.getAttribute(i)),
//             "string" == typeof n)
//           ) {
//             try {
...
//               },
//           l = s(),
//           u = (n && n[3]) || (xt.cssNumber[t] ? "" : "px"),
//           c = (xt.cssNumber[t] || ("px" !== u && +l)) && Vt.exec(xt.css(e, t));
//         if (c && c[3] !== u) {
//           for (l /= 2, u = u || c[3], c = +l || 1; o--; )
//             xt.style(e, t, c + u),
//               (1 - a) * (1 - (a = s() / l || 0.5)) <= 0 && (o = 0),
//               (c /= a);
//           (c = 2 * c), xt.style(e, t, c + u), (n = n || []);
//         }
//         return (
//           n &&
//             ((c = +c || +l || 0),
...
//               t
//                 ? ("none" === n &&
//                     ((r[a] = Ft.get(i, "display") || null),
//                     r[a] || (i.style.display = "")),
//                   "" === i.style.display && Gt(i) && (r[a] = b(i)))
//                 : "none" !== n && ((r[a] = "none"), Ft.set(i, "display", n)));
//         for (a = 0; o > a; a++) null != r[a] && (e[a].style.display = r[a]);
//         return e;
//       }
//       function k(e, t) {
//         var n;
...
//           if (r && xt.inArray(o, r) > -1) a && a.push(o);
//           else if (
//             ((c = xt.contains(o.ownerDocument, o)),
//             (s = k(p.appendChild(o), "script")),
//             c && x(s),
//             n)
//           )
//             for (d = 0; (o = s[d++]); ) Zt.test(o.type || "") && n.push(o);
//         return p;
//       }
//       function T() {
//         return !0;
...
//             ((o = r),
//             (r = function (e) {
//               return xt().off(e), o.apply(this, arguments);
//             }),
...
//           if (
//             Ft.hasData(e) &&
//             ((a = Ft.access(e)), (o = Ft.set(t, a)), (u = a.events))
//           ) {
...
//           }
//           qt.hasData(e) &&
//             ((s = qt.access(e)), (l = xt.extend({}, s)), qt.set(t, l));
//         }
//       }
//       function L(e, t) {
//         var n = t.nodeName.toLowerCase();
//         "input" === n && Yt.test(e.type)
//           ? (t.checked = e.checked)
//           : ("input" === n || "textarea" === n) &&
...
//         if (
//           g ||
//           (p > 1 && "string" == typeof h && !vt.checkClone && un.test(h))
//         )
//           return e.each(function (n) {
//             var a = e.eq(n);
//             g && (t[0] = h.call(this, n, a.html())), O(a, t, i, r);
//           });
//         if (
//           p &&
//           ((a = _(t, e[0].ownerDocument, !1, e, r)),
//           (o = a.firstChild),
//           1 === a.childNodes.length && (a = o),
//           o || r)
//         ) {
//           for (s = xt.map(k(a, "script"), R), l = s.length; p > d; d++)
//             (u = a),
//               d !== f &&
//                 ((u = xt.clone(u, !0, !0)), l && xt.merge(s, k(u, "script"))),
//               i.call(e[d], u, d);
//           if (l)
//             for (
//               c = s[s.length - 1].ownerDocument, xt.map(s, N), d = 0;
//               l > d;
//               d++
//             )
//               (u = s[d]),
//                 Zt.test(u.type || "") &&
//                   !Ft.access(u, "globalEval") &&
//                   xt.contains(c, u) &&
//                   (u.src && "module" !== (u.type || "").toLowerCase()
//                     ? xt._evalUrl && xt._evalUrl(u.src)
//                     : n(u.textContent.replace(cn, ""), c, u));
//         }
//         return e;
//       }
//       function M(e, t, n) {
...
//             i.parentNode &&
//               (n && xt.contains(i.ownerDocument, i) && x(k(i, "script")),
...
//           if (((e = yn[n] + t), e in bn)) return e;
//       }
//       function H(e) {
//         var t = xt.cssProps[e];
//         return t || (t = xt.cssProps[e] = z(e) || e), t;
//       }
//       function B(e, t, n) {
//         var i = Vt.exec(t);
...
//             i
//               ? ("content" === n && (l -= xt.css(e, "padding" + Xt[o], !0, r)),
//                 "margin" !== n &&
//                   (l -= xt.css(e, "border" + Xt[o] + "Width", !0, r)))
//               : ((l += xt.css(e, "padding" + Xt[o], !0, r)),
//                 "padding" !== n
//                   ? (l += xt.css(e, "border" + Xt[o] + "Width", !0, r))
//                   : (s += xt.css(e, "border" + Xt[o] + "Width", !0, r)));
//         return (
//           !i &&
//             a >= 0 &&
//             (l += Math.max(
...
//         }
//         return (
//           (o = o && (vt.boxSizingReliable() || r === e.style[t])),
//           ("auto" === r ||
//             (!parseFloat(r) && "inline" === xt.css(e, "display", !1, i))) &&
//             ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = !0)),
//           (r = parseFloat(r) || 0),
...
//       function U() {
//         kn &&
//           (ot.hidden === !1 && e.requestAnimationFrame
//             ? e.requestAnimationFrame(U)
//             : e.setTimeout(U, xt.fx.interval),
//           xt.fx.tick());
//       }
//       function J() {
//         return (
...
//           p.always(function () {
//             p.always(function () {
//               o.unqueued--, xt.queue(e, "fx").length || o.empty.fire();
//             });
//           }));
//         for (i in t)
//           if (((r = t[i]), xn.test(r))) {
...
//           }
//         if (((l = !xt.isEmptyObject(t)), l || !xt.isEmptyObject(f))) {
//           d &&
//             1 === e.nodeType &&
...
//                 : (m = Ft.access(e, "fxshow", { display: u })),
//               a && (m.hidden = !g),
//               g && w([e], !0),
//               p.done(function () {
//                 g || w([e]), Ft.remove(e, "fxshow");
//                 for (i in f) xt.style(e, i, f[i]);
//               })),
//               (l = V(g ? m[i] : 0, i, p)),
//               i in m ||
...
//             return (
//               yt(i.stop) &&
//                 (xt._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)),
//               i
//             );
//         return (
//           xt.map(c, V, u),
...
//           xt.fx.timer(xt.extend(l, { elem: e, anim: u, queue: u.opts.queue })),
//           u
//         );
//       }
//       function $(e) {
...
//                     (i = e[t]),
//                     o !== i &&
//                       (u && i && (xt.isPlainObject(i) || (r = Array.isArray(i)))
//                         ? (r
//                             ? ((r = !1), (a = n && Array.isArray(n) ? n : []))
//                             : (a = n && xt.isPlainObject(n) ? n : {}),
//                           (o[t] = xt.extend(u, a, i)))
//                         : void 0 !== i && (o[t] = i));
//             return o;
//           }),
...
//             var t, n;
//             return e && "[object Object]" === ft.call(e)
//               ? (t = st(e))
//                 ? ((n = ht.call(t, "constructor") && t.constructor),
//                   "function" == typeof n && gt.call(n) === mt)
//                 : !0
//               : !1;
//           },
...
//               null != e &&
//                 (r(Object(e))
//                   ? xt.merge(n, "string" == typeof e ? [e] : e)
//                   : ct.call(n, e)),
//               n
//             );
//           },
...
//           (xt.fn[Symbol.iterator] = at[Symbol.iterator]),
//         xt.each(
...
//           if (
//             !i &&
//             ((t ? t.ownerDocument || t : F) !== O && L(t), (t = t || O), D)
//           ) {
//             if (11 !== h && (l = vt.exec(e)))
//               if ((r = l[1])) {
//                 if (9 === h) {
...
//                 )
//                   u[a] = "#" + s + " " + f(u[a]);
//                 (c = u.join(",")), (p = (yt.test(e) && d(t.parentNode)) || t);
//               }
//               if (c)
//                 try {
...
//                     : t.disabled === e
//                   : t.isDisabled === e || (t.isDisabled !== !e && Tt(t) === e)
//                 : t.disabled === e
//               : "label" in t
//               ? t.disabled === e
//               : !1;
...
//             (a = e[s]) && (!n || n(a, i, r)) && (o.push(a), u && t.push(s));
//           return o;
//         }
...
//                 b = n ? (a || (i ? e : h || r) ? [] : o) : y;
//               if ((n && n(y, b, s, l), r))
//                 for (u = v(b, f), r(u, [], s, l), c = u.length; c--; )
//                   (d = u[c]) && (b[f[c]] = !(y[f[c]] = d));
//               if (i) {
//                 if (a || e) {
//                   if (a) {
...
//                       (i[u] = !(o[u] = d));
//                 }
//               } else (b = v(b === o ? b.splice(h, b.length) : b)), a ? a(null, o, b, l) : Q.apply(o, b);
//             })
//           );
//         }
//         function b(e) {
...
//                 if (a && c) {
//                   for (
//                     d = 0, o || c.ownerDocument === O || (L(c), (s = !D));
//                     (p = e[d++]);
...
//               }
//               if (((f += h), r && h !== f)) {
//                 for (d = 0; (p = n[d++]); ) p(g, m, o, s);
//                 if (i) {
//                   if (f > 0) for (; h--; ) g[h] || m[h] || (m[h] = $.call(l));
//                   m = v(m);
//                 }
//                 Q.apply(l, m),
//                   u &&
...
//                               ? e === O || (e.ownerDocument === F && B(F, e))
//                                 ? -1
//                                 : t === O || (t.ownerDocument === F && B(F, t))
//                                 ? 1
//                                 : N
//                                 ? et(N, e) - et(N, t)
//                                 : 0
...
//             return (e.ownerDocument || e) !== O && L(e), B(e, t);
//           }),
//           (t.attr = function (e, t) {
//             (e.ownerDocument || e) !== O && L(e);
//             var n = _.attrHandle[t.toLowerCase()],
//               i =
//                 n && G.call(_.attrHandle, t.toLowerCase())
//                   ? n(e, t, !D)
//                   : void 0;
//             return void 0 !== i
//               ? i
...
//                   (r = ut.exec(s)) &&
//                     ((i = r.shift()),
//                     a.push({ value: i, type: r[0].replace(st, " ") }),
//                     (s = s.slice(i.length)));
//                 for (o in _.filter)
//                   !(r = ft[o].exec(s)) ||
//                     (u[o] && !(r = u[o](r))) ||
...
//                   (a = b(t[n])), a[I] ? i.push(a) : r.push(a);
//                 (a = V(e, w(r, i))), (a.selector = e);
//               }
//               return a;
//             }),
//           (E = t.select =
...
//                 ) {
//                   if (
//                     ((t = (_.find.ID(o.matches[0].replace(bt, wt), t) ||
//                       [])[0]),
//                     !t)
//                   )
//                     return n;
...
//                 }
//                 for (
//                   r = ft.needsContext.test(e) ? 0 : a.length;
//                   r-- && ((o = a[r]), !_.relative[(s = o.type)]);

//                 )
//                   if (
//                     (l = _.find[s]) &&
//                     (i = l(
//                       o.matches[0].replace(bt, wt),
//                       (yt.test(a[0].type) && d(t.parentNode)) || t
//                     ))
//                   ) {
...
//             ? xt.find.matchesSelector(i, e)
//               ? [i]
//               : []
//             : xt.find.matches(
//                 e,
//                 xt.grep(t, function (e) {
//                   return 1 === e.nodeType;
//                 })
//               )
//         );
...
//             if ("string" != typeof e)
//               return this.pushStack(
//                 xt(e).filter(function () {
//                   for (t = 0; i > t; t++)
//                     if (xt.contains(r[t], this)) return !0;
//                 })
//               );
//             for (n = this.pushStack([]), t = 0; i > t; t++) xt.find(e, r[t], n);
...
//             return !!o(
//               this,
//               "string" == typeof e && Ct.test(e) ? xt(e) : e || [],
//               !1
//             ).length;
//           },
//         });
//       var Rt,
//         Nt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
//         jt = (xt.fn.init = function (e, t, n) {
//           var i, r;
//           if (!e) return this;
//           if (((n = n || Rt), "string" == typeof e)) {
//             if (
//               ((i =
...
//             if (i[1]) {
//               if (
//                 ((t = t instanceof xt ? t[0] : t),
//                 xt.merge(
//                   this,
//                   xt.parseHTML(
//                     i[1],
//                     t && t.nodeType ? t.ownerDocument || t : ot,
//                     !0
//                   )
//                 ),
//                 Et.test(i[1]) && xt.isPlainObject(t))
//               )
//                 for (i in t) yt(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
//               return this;
//             }
//             return (
//               (r = ot.getElementById(i[2])),
...
//             for (var e = 0; n > e; e++) if (xt.contains(this, t[e])) return !0;
//           });
//         },
...
//                   (o
//                     ? o.index(n) > -1
//                     : 1 === n.nodeType && xt.find.matchesSelector(n, e))
//                 ) {
//                   a.push(n);
//                   break;
//                 }
...
//                 this.length > 1 &&
//                   (Ot[e] || xt.uniqueSort(r), Lt.test(e) && r.reverse()),
//                 this.pushStack(r)
//               );
//             };
//           }
...
//           u = -1,
//           c = function () {
//             for (a = a || e.once, r = t = !0; s.length; u = -1)
...
//             remove: function () {
//               return (
//                 xt.each(arguments, function (e, t) {
...
//                                   xt.Deferred.exceptionHook(e, p.stackTrace),
//                                   t + 1 >= o &&
//                                     (i !== c && ((s = void 0), (l = [e])),
//                                     n.rejectWith(s, l));
//                               }
...
//             if (
//               1 >= t &&
//               (d(e, a.done(o(n)).resolve, a.reject, !t),
//               "pending" === a.state() || yt(r[n] && r[n].then))
//             )
//               return a.then();
//             for (; n--; ) d(r[n], o(n), a.reject);
//             return a.promise();
//           },
//         });
...
//                 Array.isArray(t)
//                   ? (t = t.map(h))
//                   : ((t = h(t)), (t = t in i ? [t] : t.match(Mt) || [])),
//                   (n = t.length);
//                 for (; n--; ) delete i[t[n]];
//               }
//               (void 0 === t || xt.isEmptyObject(i)) &&
//                 (e.nodeType
...
//                     var n;
//                     if (a && void 0 === t) {
//                       if (((n = qt.get(a, e)), void 0 !== n)) return n;
...
//                 n &&
//                   (!i || Array.isArray(n)
//                     ? (i = Ft.access(e, t, xt.makeArray(n)))
//                     : i.push(n)),
//                 i || [])
//               : void 0;
//           },
...
//               ("" === e.style.display &&
//                 xt.contains(e.ownerDocument, e) &&
//                 "none" === xt.css(e, "display"))
//           );
//         },
//         Kt = function (e, t, n, i) {
//           var r,
...
//                   (o = m.handle =
//                     function (t) {
//                       return "undefined" != typeof xt &&
//                         xt.event.triggered !== t.type
//                         ? xt.event.dispatch.apply(e, arguments)
//                         : void 0;
//                     }),
//                 t = (t || "").match(Mt) || [""],
//                 u = t.length;
...
//                     ((p = l[f] = []),
//                     (p.delegateCount = 0),
//                     (d.setup && d.setup.call(e, i, h, o) !== !1) ||
...
//             h,
//             g,
//             m = Ft.hasData(e) && Ft.get(e);
//           if (m && (l = m.events)) {
//             for (t = (t || "").match(Mt) || [""], u = t.length; u--; )
//               if (
//                 ((s = on.exec(t[u]) || []),
//                 (f = g = s[1]),
//                 (h = (s[2] || "").split(".").sort()),
...
//                     xt.removeEvent(e, f, m.handle),
//                   delete l[f]);
//               } else for (f in l) xt.event.remove(e, f + t[u], n, i, !0);
...
//             u = (Ft.get(this, "events") || {})[s.type] || [],
//             c = xt.event.special[s.type] || {};
...
//           ) {
//             for (
//               o = xt.event.handlers.call(this, s, u), t = 0;
//               (r = o[t++]) && !s.isPropagationStopped();

//             )
//               for (
//                 s.currentTarget = r.elem, n = 0;
//                 (a = r.handlers[n++]) && !s.isImmediatePropagationStopped();
...
//                   (s.data = a.data),
//                   (i = (
//                     (xt.event.special[a.origType] || {}).handle || a.handler
//                   ).apply(r.elem, l)),
//                   void 0 !== i &&
//                     (s.result = i) === !1 &&
...
//           click: {
//             trigger: function () {
//               return "checkbox" === this.type && this.click && a(this, "input")
//                 ? (this.click(), !1)
//                 : void 0;
//             },
//             _default: function (e) {
...
//           return this instanceof xt.Event
//             ? (e && e.type
...
//             which: function (e) {
//               var t = e.button;
//               return null == e.which && rn.test(e.type)
//                 ? null != e.charCode
//                   ? e.charCode
//                   : e.keyCode
//                 : !e.which && void 0 !== t && an.test(e.type)
//                 ? 1 & t
//                   ? 1
//                   : 2 & t
//                   ? 3
...
//             o,
//             s = e.cloneNode(!0),
//             l = xt.contains(e.ownerDocument, e);
//           if (
//             !(
//               vt.noCloneChecked ||
...
//             )
//           )
//             for (o = k(s), a = k(e), i = 0, r = a.length; r > i; i++)
//               L(a[i], o[i]);
//           if (t)
//             if (n)
//               for (
//                 a = a || k(e), o = o || k(s), i = 0, r = a.length;
//                 r > i;
//                 i++
//               )
//                 j(a[i], o[i]);
//             else j(e, s);
//           return (
//             (o = k(s, "script")), o.length > 0 && x(o, !l && k(e, "script")), s
//           );
//         },
//         cleanData: function (e) {
//           for (
//             var t, n, i, r = xt.event.special, a = 0;
//             void 0 !== (n = e[a]);
//             a++
//           )
//             if (It(n)) {
...
//               1 === e.nodeType &&
//                 (xt.cleanData(k(e, !1)), (e.textContent = ""));
//             return this;
//           },
//           clone: function (e, t) {
//             return (
...
//                       (t = this[n] || {}),
//                         1 === t.nodeType &&
//                           (xt.cleanData(k(t, !1)), (t.innerHTML = e));
//                     t = 0;
//                   } catch (r) {}
//                 }
...
//                 xt.inArray(this, e) < 0 &&
//                   (xt.cleanData(k(this)), n && n.replaceChild(t, this));
//               },
//               e
//             );
//           },
...
//             xt.fn[e] = function (e) {
//               for (
//                 var n, i = [], r = xt(e), a = r.length - 1, o = 0;
//                 a >= o;
//                 o++
//               )
...
//         vn = { letterSpacing: "0", fontWeight: "400" },
//         yn = ["Webkit", "Moz", "ms"],
...
//               var r,
//                 a = pn(e),
//                 o = "border-box" === xt.css(e, "boxSizing", !1, a),
//                 s = i && I(e, t, i, o, a);
//               return (
//                 o &&
//                   vt.scrollboxSize() === a.position &&
//                   (s -= Math.ceil(
...
//                 ? e.elem[e.prop]
//                 : ((t = xt.css(e.elem, e.prop, "")), t && "auto" !== t ? t : 0);
//             },
//             set: function (e) {
//               xt.fx.step[e.prop]
//                 ? xt.fx.step[e.prop](e)
//                 : 1 !== e.elem.nodeType ||
//                   (null == e.elem.style[xt.cssProps[e.prop]] &&
//                     !xt.cssHooks[e.prop])
//                 ? (e.elem[e.prop] = e.now)
//                 : xt.style(e.elem, e.prop, e.now + e.unit);
//             },
//           },
//         }),
...
//               return y(n.elem, e, Vt.exec(t), n), n;
//             },
//           ],
//         },
//         tweener: function (e, t) {
//           yt(e) ? ((t = e), (e = ["*"])) : (e = e.match(Mt));
//           for (var n, i = 0, r = e.length; r > i; i++)
//             (n = e[i]),
...
//                 (i.duration =
//                   i.duration in xt.fx.speeds
//                     ? xt.fx.speeds[i.duration]
...
//                 else for (r in o) o[r] && o[r].stop && _n.test(r) && i(o[r]);
//                 for (r = a.length; r--; )
//                   a[r].elem !== this ||
//                     (null != e && a[r].queue !== e) ||
...
//           n.length || xt.fx.stop(), (wn = void 0);
//         }),
//         (xt.fx.timer = function (e) {
//           xt.timers.push(e), xt.fx.start();
//         }),
//         (xt.fx.interval = 13),
...
//                 : ((1 === a && xt.isXMLDoc(e)) ||
//                     (r =
//                       xt.attrHooks[t.toLowerCase()] ||
//                       (xt.expr.match.bool.test(t) ? Tn : void 0)),
//                   void 0 !== n
//                     ? null === n
...
//                     ? i
//                     : ((i = xt.find.attr(e, t)), null == i ? void 0 : i));
//           },
//           attrHooks: {
//             type: {
//               set: function (e, t) {
...
//         (Tn = {
//           set: function (e, t, n) {
//             return t === !1 ? xt.removeAttr(e, n) : e.setAttribute(n, n), n;
//           },
//         }),
...
//               return (
//                 (1 === a && xt.isXMLDoc(e)) ||
//                   ((t = xt.propFix[t] || t), (r = xt.propHooks[t])),
//                 void 0 !== n
//                   ? r && "set" in r && void 0 !== (i = r.set(e, n, t))
//                     ? i
//                     : (e[t] = n)
...
//                 return t
//                   ? parseInt(t, 10)
//                   : Sn.test(e.nodeName) || (Cn.test(e.nodeName) && e.href)
//                   ? 0
//                   : -1;
//               },
//             },
...
//                   var r;
//                   1 === this.nodeType &&
//                     ((r = i ? e.call(this, n, xt(this).val()) : e),
//                     null == r
//                       ? (r = "")
//                       : "number" == typeof r
//                       ? (r += "")
//                       : Array.isArray(r) &&
//                         (r = xt.map(r, function (e) {
//                           return null == e ? "" : e + "";
//                         })),
//                     (t =
...
//               set: function (e, t) {
//                 for (
//                   var n, i, r = e.options, a = xt.makeArray(t), o = r.length;
//                   o--;

//                 )
//                   (i = r[o]),
//                     (i.selected =
//                       xt.inArray(xt.valHooks.option.get(i), a) > -1) &&
//                       (n = !0);
...
//                 ? (e.checked = xt.inArray(xt(e).val(), t) > -1)
//                 : void 0;
//             },
//           }),
//             vt.checkOn ||
//               (xt.valHooks[this].get = function (e) {
...
//             g = ht.call(t, "namespace") ? t.namespace.split(".") : [];
//           if (
//             ((o = p = s = i = i || ot),
//             3 !== i.nodeType &&
//               8 !== i.nodeType &&
//               !Rn.test(h + xt.event.triggered) &&
//               (h.indexOf(".") > -1 &&
//                 ((g = h.split(".")), (h = g.shift()), g.sort()),
//               (u = h.indexOf(":") < 0 && "on" + h),
//               (t = t[xt.expando]
//                 ? t
//                 : new xt.Event(h, "object" == typeof t && t)),
//               (t.isTrigger = r ? 2 : 3),
//               (t.namespace = g.join(".")),
...
//               for (
//                 l = d.delegateType || h, Rn.test(l + h) || (o = o.parentNode);
//                 o;
//                 o = o.parentNode
//               )
//                 f.push(o), (s = o);
//               s === (i.ownerDocument || ot) &&
...
//                 (c =
//                   (Ft.get(o, "events") || {})[t.type] && Ft.get(o, "handle")),
//                 c && c.apply(o, n),
//                 (c = u && o[u]),
//                 c &&
//                   c.apply &&
...
//           var i = xt.extend(new xt.Event(), n, { type: e, isSimulated: !0 });
...
//                 r
//                   ? Ft.access(i, t, r)
//                   : (i.removeEventListener(e, n, !0), Ft.remove(i, t));
//               },
//             };
//           });
//       var jn = e.location,
...
//                       : 304 === t
//                       ? (x = "notmodified")
//                       : ((x = w.state), (p = w.data), (f = w.error), (u = !f)))
//                   : ((f = x), (t || !x) && ((x = "error"), 0 > t && (t = 0))),
//                 (_.status = t),
//                 (_.statusText = (n || x) + ""),
...
//                 (b = void 0),
//                 d &&
//                   m.trigger(u ? "ajaxSuccess" : "ajaxError", [_, h, u ? p : f]),
//                 y.fireWith(g, [_, x]),
//                 d &&
...
//               h = xt.ajaxSetup({}, n),
//               g = h.context || h,
//               m = h.context && (g.nodeType || g.jquery) ? xt(g) : xt.event,
//               v = xt.Deferred(),
...
//                   (u.href = u.href),
//                   (h.crossDomain =
//                     Gn.protocol + "//" + Gn.host != u.protocol + "//" + u.host);
//               } catch (T) {
//                 h.crossDomain = !0;
//               }
//             }
...
//                 (h.data = xt.param(h.data, h.traditional)),
//               tt(Wn, h, n, _),
//               c)
//             )
//               return _;
...
//                     ) &&
//                   (h.data = h.data.replace(Hn, "+"))
//                 : ((f = h.url.slice(a.length)),
//                   h.data &&
//                     (h.processData || "string" == typeof h.data) &&
//                     ((a += (On.test(a) ? "&" : "?") + h.data), delete h.data),
//                   h.cache === !1 &&
//                     ((a = a.replace(In, "$1")),
//                     (f = (On.test(a) ? "&" : "?") + "_=" + Ln++ + f)),
//                   (h.url = a + f)),
//               h.ifModified &&
//                 (xt.lastModified[a] &&
//                   _.setRequestHeader("If-Modified-Since", xt.lastModified[a]),
...
//               (r = tt(Vn, h, n, _)))
//             ) {
//               if (((_.readyState = 1), d && m.trigger("ajaxSend", [_, h]), c))
//                 return _;
//               h.async &&
//                 h.timeout > 0 &&
...
//             ? ((r = t.jsonpCallback =
//                 yt(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
//               s
//                 ? (t[s] = t[s].replace(Qn, "$1" + r))
//                 : t.jsonp !== !1 &&
...
//                   t[r] && ((t.jsonpCallback = n.jsonpCallback), Yn.push(r)),
//                   o && yt(a) && a(o[0]),
//                   (o = a = void 0);
//               }),
//               "script")
...
//                 ? ((t = ot.implementation.createHTMLDocument("")),
...
//                   var a;
//                   return (
//                     bt(e) ? (a = e) : 9 === e.nodeType && (a = e.defaultView),
//                     void 0 === r
//                       ? a
//                         ? a[t]
//                         : e[i]
...
//             return n
//               ? ((n = D(e, t)), dn.test(n) ? xt(e).position()[t] + "px" : n)
//               : void 0;
//           });
//         }),
...
//           i = e("underscore"),
//           r = e("utils/constants"),
//           a = i.template(e("text!views/login.html")),
//           o = e("utils/jquery-amd"),
//           s = e("text!stylesheets/login.css"),
//           l = e("logger"),
//           u = e("dialogv2"),
//           c = e("runtime"),
//           d = e("auth"),
//           p = e("utils/browser-request");
...
//               if (n)
//                 return e({ authResponse: null, success: !1, status: null });
//               if (
//                 (r.error && t(".status").html(r.error).show(), r.access_token)
//               ) {
//                 t(".status").hide();
//                 var a = {
//                     success: !0,
...
//         "underscore",
//         "utils/constants",
//         "text!views/registration.html",
//         "utils/jquery-amd",
//         "text!stylesheets/registration.css",
//       ],
//       function (e) {
//         var t,
//           n = e("logger"),
...
//           f = e("underscore"),
//           h = e("utils/constants"),
//           g = f.template(e("text!views/registration.html")),
//           m = e("utils/jquery-amd"),
//           v = e("text!stylesheets/registration.css"),
//           y = function () {
//             w();
//             var e = {
...
//             };
//             if (
//               (T("nickname") && (e.body.meta.nickname = l("#nickname").val()),
//               T("first_name") &&
//                 (e.body.meta.first_name = l("#first_name").val()),
...
//           },
//           w = function () {
//             l(".error_explanation").hide(), l(".error_explanation").html("");
//           },
//           k = function (e) {
//             (u = e), (d = A()), S(), x(), l(".step" + e).show();
//           },
//           x = function () {
//             l(".step1").hide(),
//               l(".step2").hide(),
...
//         (p.step1 = function () {
//           var e =
//               T("generated_nickname") ||
//               !T("nickname") ||
//               l("#nickname").val().length > 2,
...
//               t = !T("city") || "" != l("#city").val(),
//               n =
//                 !T("state_or_province") || "" != l("#state_or_province").val(),
...
//                   u == d.length && (l(".norm").hide(), l(".finish").show()))
//                 : (l(".next-disabled").show(),
//                   l(".norm").hide(),
//                   l(".finish").hide(),
//                   l(".finish-disabled").hide(),
//                   u == d.length &&
//                     (l(".next-disabled").hide(), l(".finish-disabled").show())),
...
//             l(".female-icon").css(
//               "background-image",
//               'url("' + h.cdnUrl + '/sdk/registration/gender-sheet.png")'
//             ),
//               l(".male-icon").css(
//                 "background-image",
//                 'url("' + h.cdnUrl + '/sdk/registration/gender-sheet.png")'
...
//           R = function (e) {
//             s = a.get.permissions;
//             var r = { permissions: s, languages: h.languages };
//             i.create(g, null, r),
//               (i.loadedCallback = function () {
//                 i.inlineStyle(v), (l = m(i.window())), n.addCall(), k(1), E();
...
//                       S(),
//                       u != d.length &&
//                         (l(".footer-terms").hide(), l(".footer-normal").show()),
//                       i.centerResize();
//                   }),
...
//                     13 == e.keyCode &&
//                       (u == d.length
//                         ? l(".finish").trigger("click")
//                         : l(".next").trigger("click"),
//                       e.preventDefault());
//                   }),
...
//                     l("#nickname").val().length < 3
//                       ? b("<li>Nickname must be 3 or more letters</li>")
//                       : w();
//                   }),
//                   l("#first_name").blur(function () {
//                     l("#first_name").val().length < 2
//                       ? b("<li>First name must have at least 2 letters</li>")
//                       : w();
//                   }),
//                   l("#last_name").blur(function () {
//                     l("#last_name").val().length < 2
//                       ? b("<li>Last name must have at least 2 letters</li>")
//                       : w();
//                   }),
//                   l("#password").blur(function () {
//                     l("#password").val().length < 5
//                       ? b("<li>Password must be 6 or more long</li>")
//                       : w();
//                   }),
...
//               });
//           };
//         return { setFlowStep: k, createMenu: R };
//       }
//     ),
//     define(
//       "dialogs_manager",
...
//                 case "apprequests":
//                   r.createIframeDialog(
//                     n,
//                     a,
//                     o("app_requests/new"),
//                     e.pick(t, "message", "redirect_uri", "data", "app_id", "to")
//                   );
//                   break;
//                 case "friends":
//                   r.createIframeDialog(
...
//                     a,
//                     o("friends/new"),
//                     e.pick(t, "redirect_uri", "app_id", "id")
//                   );
//                   break;
//                 case "leaderboard":
//                   r.createIframeDialog(
...
//           };
//         return (
//           (a.events["dialog.finished"] = function (e) {
...
//       return {
//         submit: function (t, n) {
//           e.api("/profile/app_image", "POST", { picture: t }, function (e) {
//             n && n(e);
//           });
//         },
//       };
...
//             for (a = (((n + 65) >>> 9) << 4) + 15, o = 16; t.length <= a; )
//               t.push(0);
//             for (
//               t[n >>> 5] |= 128 << (24 - (n % 32)),
//                 n += i,
...
//             if ("SHA-224" === e) t = [r[0], r[1], r[2], r[3], r[4], r[5], r[6]];
//             else {
//               if ("SHA-256" !== e)
//                 throw Error("Unexpected error in SHA-2 implementation");
//               t = r;
...
//               t / 8 > r)
//             ) {
//               for (n = g(n, t, 0, b(e)); n.length <= i; ) n.push(0);
//               n[i] &= 4294967040;
//             } else if (r > t / 8) {
...
//             }
//             for (t = 0; i >= t; t += 1)
//               (T[t] = 909522486 ^ n[t]), (A[t] = 1549556828 ^ n[t]);
//             (c = h(T, c)), (y = f), (_ = !0);
//           }),
...
//               a = f >>> 5;
//             for (
//               t = d(e, k, x), e = t.binLen, n = t.value, t = e >>> 5, i = 0;
//               t > i;
//               i += a
//             )
//               e >= r + f && ((c = h(n.slice(i, i + a), c)), (r += f));
//             (y += r), (k = n.slice(r >>> 5)), (x = e % f), (S = !0);
//           }),
...
//             }
//             for (f = g(k.slice(), x, y, m(c)), u = 1; v > u; u += 1)
//               f = g(f, p, 0, b(e));
//             return l(f);
//           }),
...
//           r = t / 8,
//           a = new ArrayBuffer(r);
//         for (i = new Uint8Array(a), n = 0; r > n; n += 1)
...
//               for (
//                 t = t || [0], n = n || 0, s = n >>> 3, i = 0;
//                 l > i;
//                 i += 2
//               ) {
//                 if (((r = parseInt(e.substr(i, 2), 16)), isNaN(r)))
//                   throw Error("String of HEX type contains invalid characters");
//                 for (o = (i >>> 1) + s, a = o >>> 2; t.length <= a; ) t.push(0);
//                 t[a] |= r << (8 * (3 + (o % 4) * -1));
//               }
...
//                 d,
//                 p = 0;
//               if (((n = n || [0]), (i = i || 0), (l = i >>> 3), "UTF8" === t))
//                 for (d = 3, o = 0; o < e.length; o += 1)
//                   for (
//                     r = e.charCodeAt(o),
//                       a = [],
//                       128 > r
...
//                     s += 1
//                   ) {
//                     for (c = p + l, u = c >>> 2; n.length <= u; ) n.push(0);
//                     (n[u] |= a[s] << (8 * (d + (c % 4) * -1))), (p += 1);
//                   }
...
//               for (
//                 t = t || [0], n = n || 0, l = n >>> 3, r = 0;
//                 r < e.length;
//                 r += 4
//               ) {
//                 for (s = e.substr(r, 4), a = o = 0; a < s.length; a += 1)
//                   (i =
...
//                   for (u = c + l, i = u >>> 2; t.length <= i; ) t.push(0);
//                   (t[i] |=
//                     ((o >>> (16 - 8 * a)) & 255) << (8 * (3 + (u % 4) * -1))),
//                     (c += 1);
//                 }
//               }
...
//         var a =
//           (65535 & e) + (65535 & t) + (65535 & n) + (65535 & i) + (65535 & r);
//         return (
//           ((((e >>> 16) +
//             (t >>> 16) +
//             (n >>> 16) +
...
//               (P[_] = new M(b, w)))
//             : (P[_] = S(R(P[_ - 2]), P[_ - 7], E(P[_ - 15]), P[_ - 16])),
//             (b = C(u, j(o), L(o, s, l), D[_], P[_])),
//             (w = A(N(n), O(n, i, r))),
//             (u = l),
//             (l = s),
//             (s = o),
...
//           r = e("logger"),
//           a = e("runtime"),
//           o = (e("dialogs_manager"), e("utils/constants")),
//           s = "",
//           l = !1,
//           u = !1,
//           c = {},
...
//                     void (e && "function" == typeof e && e(n, i)))
//                   : void (e && "function" == typeof e && e(n, i));
//               };
//               d.sendAPIRequest("init", "start", i, n, null);
//             },
//             sendAPIRequest: function (e, n, l, u, c) {
//               var d = this;
//               (c = c || {}),
//                 (c.section = e),
//                 (c.action = n),
...
//                     !this.loaded &&
//                     this.debug &&
//                     r.log("init has yet to be called, trying to send anyway"));
//               var p = JSON.stringify(c),
//                 f = new i("SHA-256", "TEXT");
//               f.update(p + s);
//               var h = f.getHash("HEX");
//               h = h.substring(0, 20);
//               var g = this.apiurl + "?hash=" + h,
//                 m = new XMLHttpRequest();
//               (m.onerror = function () {
//                 l(u, c, {}, t(!1, 1));
//               }),
//                 (m.onload = function () {
//                   d.debug && r.log(m.responseText);
//                   var e = JSON.parse(m.responseText);
//                   l(u, c, e, t(e.success, e.errorcode));
//                 }),
//                 "save" === n &&
//                   ((m.withCredentials = !0),
//                   (g = o.root_url + "/playtomic?hash=" + h)),
//                 m.open("POST", g, !0),
//                 m.send(p);
//             },
//           };
...
//         "utils/constants",
//         "runtime",
//         "text!views/leaderboard.html",
//         "utils/jquery-amd",
//         "text!stylesheets/leaderboard.css",
//       ],
//       function (e) {
//         var t,
//           n,
...
//           a,
//           o = e("underscore"),
//           s = e("playtomic_helper"),
//           l = (e("logger"), e("dialogv2")),
//           u = e("utils/constants"),
//           c = e("runtime"),
//           d = o.template(e("text!views/leaderboard.html")),
//           p = e("utils/jquery-amd"),
//           f = e("text!stylesheets/leaderboard.css"),
//           h = 1,
//           g = function (e, r, a) {
//             try {
//               (i = a.scores),
...
//                 if (r.useMilli) var s = w(i[o].points);
//                 else var s = i[o].points;
//                 t(".scores").append(
//                   '<div class="scoreitem blackish"><div class="numcol hidetext nopadding">' +
//                     i[o].rank +
//                     '.</div><div class="namecol blueish hidetext nopadding">  <a href="' +
//                     u.root_url +
//                     "/profiles/" +
//                     i[o].playerid +
//                     '" target="_blank">' +
//                     i[o].playername +
//                     '</a></div><div class="scorecol hidetext nopadding">' +
//                     s +
//                     '</div><div class="datecol lightgray fullcap hidetext nopadding">' +
//                     i[o].rdate +
//                     "</div></div>"
//                 );
//               }
//               l.centerResize();
//             } catch (c) {
//               console.log(c), l.destroy();
//             }
//           },
//           m = function (e, n, i) {
//             t(".pscore").html(
//               i.hasOwnProperty("scores") && i.scores.length > 0
//                 ? n.useMilli
//                   ? w(i.scores[0].points)
//                   : i.scores[0].points
//                 : "none yet"
...
//               t(".page").html(l.i18n.t("sdk.playtomic.page", { num: e }));
//           },
//           y = function () {
//             t(".pagination").click(function (e) {
//               -1 != e.target.className.search("left-arrow")
//                 ? h--
//                 : -1 != e.target.className.search("right-arrow") && h++,
//                 (r.page = h),
//                 s.sendAPIRequest("leaderboards", "list", g, null, r);
//             }),
//               t(".butwrap").click(function (e) {
//                 -1 != e.target.className.search("alltime") &&
//                   (r.mode = "alltime"),
//                   -1 != e.target.className.search("last30days") &&
//                     (r.mode = "last30days"),
//                   -1 != e.target.className.search("last7days") &&
//                     (r.mode = "last7days"),
//                   -1 != e.target.className.search("newest") &&
//                     (r.mode = "newest"),
//                   (h = 1),
//                   (n = r.mode),
//                   (r.page = h),
...
//           b = function () {
//             c.getOAuthToken()
//               ? ((a.playerid = c.getAuthResponse().details.pid),
//                 t(".pmsg").show(),
//                 t(".pscore").show(),
//                 t(".regbut").hide(),
//                 s.sendAPIRequest("leaderboards", "list", m, null, a))
//               : (t(".pmsg").hide(), t(".pscore").hide(), t(".regbut").show());
//           },
//           w = function (e) {
...
//         "utils/constants",
//         "runtime",
//         "text!views/achievements.html",
//         "utils/jquery-amd",
//         "text!stylesheets/achievements.css",
//       ],
//       function (e) {
//         var t,
//           n,
...
//           a = (e("logger"), e("dialogv2")),
//           o = e("utils/constants"),
//           s = e("runtime"),
//           l = i.template(e("text!views/achievements.html")),
//           u = e("utils/jquery-amd"),
//           c = e("text!stylesheets/achievements.css"),
//           d = o.cdnUrl + "/sdk/achievements/lock.png",
//           p = o.cdnUrl + "/sdk/achievements/gradient.png",
//           f = function (e, i, r) {
//             n = r.achievements;
//             for (var a = 0; a < n.length; a++) {
//               var l = n[a].hasOwnProperty("player") ? "hide" : "",
//                 u =
//                   o.cdnUrl + "/achievements/" + s.getAppId() + "/" + n[a].icon,
//                 c =
//                   '<div class="achitem" data-id="' +
//                   a +
//                   '"><img src="' +
//                   u +
//                   '"><div class="botrow ' +
...
//                 e || (e = {}),
//                   i.getOAuthToken() &&
//                     (e.playerid = i.getAuthResponse().details.pid),
//                   o.showList(e);
//               },
...
//               },
//               save: function (e, a) {
//                 return i.getOAuthToken()
//                   ? ((e.playerid = i.getAuthResponse().details.pid),
//                     (e.playername = i.getAuthResponse().details.nickname),
//                     void r.sendAPIRequest("achievements", "save", t, a, e))
//                   : void (
//                       this.debug &&
//                       n.log("user must login before saving an achievement")
//                     );
//               },
//             },
//             Leaderboards: {
...
//                 (e.hasOwnProperty("playerid") && e.playerid != o) ||
//                   ((e.playerid = o),
...
//                 if (!i.getOAuthToken())
//                   return void (
//                     this.debug && n.log("user must login before saving a map")
//                   );
...
//                 if (o) {
//                   if (i > 10 && this.debug)
//                     return n.log("perPage set too high on mapListCustom"), !1;
//                 } else if (i > 50 && this.debug)
//                   return n.log("perPage set too high on mapListCustom"), !1;
//                 var l = { mode: e, perpage: i, page: a, data: o };
...
//                 if (!i.getOAuthToken())
//                   return void (
//                     this.debug && n.log("user must login before rating a map")
//                   );
//                 var s = {
//                   levelid: e,
//                   rating: a,
...
//     define(
//       "protection",
//       ["require", "utils/domain", "sdk/api", "logger"],
//       function (e) {
//         var t = e("utils/domain"),
//           n = e("sdk/api"),
//           i = e("logger"),
...
//             }, 1e4);
//             0 === a.length
//               ? n.apiOpen("protection-lists", "GET", null, function (n) {
//                   n.hasOwnProperty("approved_domains") &&
//                     ((a = n.approved_domains), (o = n.blacklisted_urls)),
//                     clearTimeout(t),
//                     e();
//                 })
//               : e();
...
//             var t = c();
//             u(function () {
//               if (-1 != t.search("y8.com/embed")) return (s = !1), void e(!1);
//               for (var n = 0; n < a.length; n++)
//                 if (-1 != r.search(a[n])) return (s = !0), void e(!0);
//               (s = !1), e(!1);
//             });
//           },
...
//             return l
//               ? void e(l)
//               : (i.history.push("Blacklist called"),
//                 void u(function () {
//                   for (var t = 0; t < o.length; t++)
//                     if (-1 != r.search(o[t])) return (l = !0), void e(!0);
//                   (l = !1), e(!1);
//                 }));
//           },
//           debug: function () {
...
//         "protection",
//         "sdk/api",
//         "text!views/secret_menu.html",
//         "text!stylesheets/secret_menu.css",
//       ],
//       function (e) {
//         var t = e("underscore"),
//           n = e("logger"),
...
//             init: function () {
//               var e = this;
//               o.y8_appid != a.getAppId() &&
//                 i.addEventListener(window, "keydown", function (t) {
//                   t.shiftKey &&
//                     t.altKey &&
//                     t.ctrlKey &&
//                     (r.loaded
//                       ? r.destroy()
//                       : ((r.loadedCallback = function () {
...
//                             (e.protectionDebug =
//                               t.getElementById("protection-debug")),
//                             i.addEventListener(
//                               e.deleteAll,
//                               "click",
//                               e.deleteAllData
...
//                               e.protectionDebug,
//                               "click",
//                               e.triggerProtectionDebug
//                             ),
//                             e.renderLogs(),
//                             (o.innerHTML = a.getAppId()),
//                             (s.innerHTML =
//                               n.getCalls() + " call in last 5 mins"),
//                             (l.innerHTML =
//                               n.getSaveSize() + " bytes saved last");
//                         }),
//                         r.create(u),
//                         r.inlineStyle(c),
...
//         userid: "",
//         nodes: [
//           ["playtomicmp1.ams3.y8.net", 3201],
//           ["playtomicmp2.ams3.y8.net", 3201],
//         ],
//         host: "",
//         port: 0,
...
//           var a =
//             Math.floor(Math.random() * (this.nodes.length - 1 + 1)) + 1 - 1;
//           (this.host = this.nodes[a][0]),
//             (this.port = this.nodes[a][1]),
//             this.openSocket(this.host, this.port),
//             this.debugLevel > 0 &&
//               e.log("connecting to " + this.host + ":" + this.port);
//         },
//         openSocket: function (t, n) {
//           var i = this;
//           (this.socket = new WebSocket(this.proto + t + ":" + n)),
...
//                 (i._message += t[n]),
//                   n < t.length - 1 &&
//                     (0 !== i._message.indexOf("{") &&
//                       (i._message = i._message.substring(
//                         i._message.indexOf("{"),
//                         i._message.length
//                       )),
...
//               if (
//                 (i.debugLevel > 0 && (e.log("SMP: disconnected"), e.log(t)),
...
//                 i.timedout ||
//                 !i.autoReconnect ||
//                 ((i.reconnects = 1), i.startReconnect());
//             });
//         },
...
//               this.matchingCallback &&
//                 this.matchingCallback(n, this.matchingScope);
//           } catch (i) {
//             return void e.log(i);
//           }
...
//                     (this.sendObject(t),
//                     this.debugLevel > 0 &&
//                       e.log("sending que" + JSON.stringify(t)));
//                 }
//               this.msgQue = [];
//             }
//             "rooms" == n.section &&
//               "playerjoined" == n.action &&
//               (this.room.players[n.playerid] = n.meta),
//               "rooms" == n.section &&
//                 "playerleft" == n.action &&
//                 delete this.room.players[n.playerid],
//               "rooms" == n.section &&
//                 "playerupdate" == n.action &&
//                 (this.room.players[n.playerid] = n.meta),
//               "rooms" == n.section &&
//                 "join" == n.action &&
//                 (this.room = n.room);
...
//           var r = { section: "rooms", action: "list", appid: this.appid };
//           e && (r.type = e),
//             t && (r.roomid = t),
//             n && (r.custom = n),
//             i && (r.pt = i),
...
//           i && (a.pt = i),
//             r[0] != this.host ||
//             r[1].substring(1) != this.port.toString().substring(1)
//               ? ((this.host = r[0]),
//                 (this.port = r[1]),
...
//           var t = { section: "rooms", action: "leave", appid: this.appid };
//           e && (t.pt = e), this.sendObject(t);
//         },
//         broadcast: function (t) {
//           (!t || "object" != typeof t || Array.isArray(t)) &&
//             e.log("SMP: broadcast takes an object for the argument"),
//             this.sendObject({
//               section: "rooms",
//               action: "broadcast",
//               appid: this.appid,
...
//         },
//         ping: function (e) {
//           var t = { section: "users", action: "ping", appid: this.appid };
//           e && (t.pt = e), this.sendObject(t);
//         },
...
//             "heartbeat" != t.action &&
//               (this.debugLevel > 1 &&
//                 ("broadcast" == t.action || "sendTo" == t.action) &&
//                 e.log("SMP: sending " + n),
//               this.debugLevel > 0 &&
//                 "broadcast" != t.action &&
//                 "sendTo" != t.action &&
...
//             ? ((this.reconnects = 0), void e.log("SMP: reconnected"))
//             : 0 === this.socket.readyState
//             ? (setTimeout(function () {
//                 t.reconnects++, t.startReconnect();
//               }, 3e3 * t.reconnects * 1.5),
//               void e.log("SMP: waiting for pending connection"))
...
//     define(
//       "matchmaking",
//       ["logger", "multiplayer", "playtomic", "runtime"],
//       function (e, t, n, i) {
//         return {
//           enabled: !1,
//           availableRooms: [],
...
//               t.appid
//                 ? n.loaded
//                   ? ((t.matchingCallback = this.callback),
//                     void (t.matchingScope = this))
//                   : void e.log(
//                       "Matchmaking Error: The Game API must be initialized before startMatchmaking"
//                     )
//                 : void e.log(
//                     "Matchmaking Error: Multiplayer.open must be called before startMatchmaking"
//                   )
//             );
//           },
//           autoJoinGame: function () {
//             var e = this;
//             t.roomList("game", null, { mm: !0 }, "mm-list");
//             var n = setInterval(function () {
//               e.availableRooms.length > 0 &&
//                 (clearInterval(n),
//                 e.playerRankTable || e.useAchievements
//                   ? e.joinBestRoom()
//                   : e.joinFullestRoom());
//             }, 100);
//           },
...
//               "mm-make" == e.pt &&
//                 this.roomList("game", null, { mm: !0 }, "mm-list"),
//               "mm-join" == e.pt &&
//                 this.userMeta({ rank: n.playerRank }, "mm-meta"),
//               "rooms" == e.section &&
//                 "leave" == e.action &&
//                 ((n.availableRooms = []), (n.playerRank = 0)),
//               "playerjoined" == e.action && clearTimeout(n.lonleyPlayerTimeout),
//               "mm-list-check" == e.pt &&
//                 ((e.rooms && 1 != e.rooms[0].playerCount) ||
//                   (clearTimeout(n.lonleyPlayerTimeout),
//                   this.roomLeave(),
//                   setTimeout(function () {
//                     n.autoJoinGame();
//                   }, 100)));
...
//             } else
//               this.useAchievements && i.getAuthResponse()
//                 ? n.Achievements.listCustom(null, this.setPlayerRank)
//                 : this.joinFullestRoom();
//           },
...
//                 e.achievements[i].hasOwnProperty("player") &&
//                   ("easy" == e.achievements[i].difficulty
//                     ? (n += 1)
//                     : "medium" == e.achievements[i].difficulty
//                     ? (n += 3)
//                     : "hard" == e.achievements[i].difficulty && (n += 9));
//               t.playerRank = n;
//             } else
//               t.playerRank =
//                 e.hasOwnProperty("scores") && e.scores.length > 0
//                   ? e.scores[0].points
//                   : 1;
//           },
...
//                 e++,
//                   0 != t.playerRank && (clearInterval(n), t.sortRoomsByRank()),
//                   e > 100 &&
//                     (clearInterval(n), (t.playerRank = 1), t.sortRoomsByRank());
//               }, 100);
//           },
...
//                 this.availableRooms[e].players[i].hasOwnProperty("rank") &&
//                   (n += availableRooms[e].players[i].rank);
//               0 != this.availableRooms[e].playerCount &&
//                 (n = Math.round(n / this.availableRooms[e].playerCount)),
//                 (this.availableRooms[e].roomRank = n);
//             }
//             for (
//               var r = { closeness: 1e5, roomid: null, node: null }, a = 0;
//               a < this.availableRooms.length;
//               a++
//             ) {
//               var o = Math.abs(
//                 this.availableRooms[a].roomRank - this.playerRank
//               );
//               o < r.closeness &&
//                 ((r.closeness = o),
...
//                   t.roomList(null, r.roomid, { mm: !0 }, "mm-list-check");
...
//                 e[n].playerCount != e[n].maxPlayers &&
//                   this.availableRooms.push(e[n]);
//             else
//               for (var i = 0; i < e.length; i++)
//                 e[i].playerCount != e[i].maxPlayers &&
//                   e[i].isOpen &&
//                   this.availableRooms.push(e[i]);
//             0 == this.availableRooms.length &&
//               t.roomCreate("game", null, { mm: !0 }, "mm-make", {
...
//                     (c = u[++r]),
//                       (l = f[o]),
//                       typeof l === s && l.length > 0
//                         ? 2 == l.length
//                           ? (this[l[0]] =
//                               typeof l[1] == a ? l[1].call(this, c) : l[1])
//                           : 3 == l.length
//                           ? (this[l[0]] =
...
//                   if (x.has(n[i][a], e)) return i === r ? t : i;
//               } else if (x.has(n[i], e)) return i === r ? t : i;
//             return e;
//           },
//         },
//         T = {
...
//             [d, [h, _.str, T.browser.oldsafari.version]],
...
//             [/(sprint\s(\w+))/i],
//             [
//               [f, _.str, T.device.sprint.vendor],
//               [c, _.str, T.device.sprint.model],
//               [p, v],
//             ],
...
//             ],
//             [d, [h, _.str, T.os.windows.version]],
//             [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
//             [
//               [d, "Windows"],
//               [h, _.str, T.os.windows.version],
//             ],
//             [/\((bb)(10);/i],
//             [[d, "BlackBerry"], h],
//             [
...
//         S = function (n, r) {
//           if (
//             ("object" == typeof n && ((r = n), (n = t)), !(this instanceof S))
//           )
...
//               return (
//                 _.rgx.call(e, a, o.browser), (e.major = x.major(e.version)), e
//               );
//             }),
//             (this.getCPU = function () {
//               var e = { architecture: t };
//               return _.rgx.call(e, a, o.cpu), e;
//             }),
//             (this.getDevice = function () {
//               var e = { vendor: t, model: t, type: t };
//               return _.rgx.call(e, a, o.device), e;
//             }),
//             (this.getEngine = function () {
//               var e = { name: t, version: t };
//               return _.rgx.call(e, a, o.engine), e;
//             }),
//             (this.getOS = function () {
//               var e = { name: t, version: t };
//               return _.rgx.call(e, a, o.os), e;
//             }),
...
//         };
//       (S.VERSION = n),
//         (S.BROWSER = { NAME: d, MAJOR: u, VERSION: h }),
//         (S.CPU = { ARCHITECTURE: g }),
//         (S.DEVICE = {
//           MODEL: c,
//           VENDOR: f,
//           TYPE: p,
...
//           EMBEDDED: k,
//         }),
//         (S.ENGINE = { NAME: d, VERSION: h }),
//         (S.OS = { NAME: d, VERSION: h }),
//         typeof exports !== o
//           ? (typeof module !== o &&
//               module.exports &&
...
//           ? define("utils/uaparser", [], function () {
//               return S;
//             })
//           : e && (e.UAParser = S);
//       var C = e && (e.jQuery || e.Zepto);
//       if (typeof C !== o) {
//         var E = new S();
//         (C.ua = E.getResult()),
//           (C.ua.get = function () {
...
//           s = e("logger"),
//           l = e("options"),
//           u = o.template(e("text!views/game_break.html")),
//           c = u(),
//           d = !1,
//           p = 0,
//           f = function (e) {
...
//           h = function () {
//             r ||
//               (document.body.insertAdjacentHTML("afterbegin", c),
...
//           },
//           x = function (e) {
//             if (((a = e), 0 == l.get.ads_enabled)) return a();
//             var t = new Date();
//             return p + 1e3 * l.get.ad_timing > t.getTime()
//               ? a()
//               : (h(),
//                 void g(function () {
//                   k(), (r.style.display = "block"), (p = t.getTime());
//                   var e = m().width,
//                     i = m().height,
//                     a = new google.ima.AdsRequest(e, i),
//                     o = l.get.afg_channel_id
//                       ? "&channel=" + l.get.afg_channel_id
//                       : "";
//                   (a.adTagUrl =
//                     "https://googleads.g.doubleclick.net/pagead/ads?ad_type=video_text_image&client=ca-games-pub-6129580795478709&description_url=http%3A%2F%2FY8.com&videoad_start_delay=30000&hl=en&max_ad_duration=60000" +
//                     o),
...
//       return {
//         baseUrl: "https://www.y8.com/api/v2/items/[ITEM_ID]/video_ad_settings",
//         get: function (e, t) {
...
//       var e = {
//         load: function (e) {
//           if (((this.opts = e || {}), !this.opts.scripts))
//             throw new Error("No scripts URLs were provided");
//           this.loadAllScripts();
//         },
//         loadAllScripts: function () {
//           return 0 == this.opts.scripts.length
//             ? void (this.opts.onLoaded && this.opts.onLoaded())
//             : void this.loadScript(
//                 this.opts.scripts.shift(),
//                 this.loadAllScripts.bind(this)
//               );
//         },
...
//               function () {
//                 (n.onreadystatechange = n.onload = null), t();
//               });
...
//               this.retries <= 0
//                 ? (console.log("No retries left, giving up"), void (t && t()))
//                 : (n && console.log(n),
...
//             (e.adsController = new google.outstream.AdsController(
//               e.container,
//               e.onAdLoaded,
//               e.onAdDone
//             )),
...
//         },
//         load: function () {
//           (e.overlayContainer.style.display = "block"), e.requestAds();
//         },
//         onAdLoaded: function () {
//           e.adsController.showAd();
//         },
//         onAdDone: function () {
//           (e.overlayContainer.style.display = "none"), e.callback();
//         },
//         requestAds: function () {
...
//           displayRetry: r(),
//           testMode: function () {
//             return this.config && this.config.hasOwnProperty("test")
//               ? this.config.test
//               : n.isEnv("development");
//           },
...
//                   "https://imasdk.googleapis.com/js/sdkloader/outstream.js",
//                 ],
...
//                   }),
//                   void (this.running = !0))
//                 : (console.log("Y8 Ads: unable to run"), void (e && e()))
//               : void this.displayRetry.retry(
//                   function () {
//                     t.display(e);
//                   },
//                   e,
//                   "Waiting for ima scripts to load"
//                 );
//           },
//           adTimeoutPassed: function () {
//             return this.testMode()
//               ? !0
//               : this.lastAdTime + 1e3 * this.config.adTiming <
//                   new Date().getTime();
//           },
//         };
//       }
...
//     define(
//       "ads_adsense",
//       ["require", "utils/constants", "utils/scripts_loader", "utils/retry"],
//       function (e) {
//         var t = e("utils/constants"),
...
//             var t = null;
//             this.config.adHost &&
//               ((t += "&host=" + this.config.adHost), (i += " AFP")),
//               (i += ": "),
//               console.log(i + "Loading adsbygoogle.js"),
//               n.load({
//                 scripts: [t],
//                 forEach: this.forEachScript.bind(this),
//                 onLoaded: function () {
//                   console.log(i + "adsbygoogle.js is loaded");
//                 },
//               }),
//               (window.adsbygoogle = window.adsbygoogle || []);
//             var r = (adConfig = function (e) {
//               adsbygoogle.push(e);
//             });
//             this.adBreak = r;
//             var a = this,
//               o = new Date();
//             console.log(
//               i + "adConfig is called, measuring time until onReady callback"
//             ),
//               adConfig({
//                 preloadAdBreaks: "on",
//                 sound: "on",
//                 onReady: function () {
//                   console.log(
//                     i + "Got onReady callback after",
//                     (new Date() - o) / 1e3,
//                     "s"
//                   ),
//                     (a.ready = !0),
//                     a.config.hasOwnProperty("onReady") && a.config.onReady();
//                 },
//               });
//           },
...
//               this.config.adHost &&
//                 e.setAttribute("data-ad-host", this.config.adHost),
//               this.testMode()
//                 ? e.setAttribute("data-adbreak-test", "on")
//                 : this.config.adChannel &&
//                   e.setAttribute("data-ad-channel", this.config.adChannel);
//           },
//           display: function (e) {
//             var t = this;
//             return this.ready
//               ? this.running
//                 ? (console.log("Ads are already running"), void (e && e()))
//                 : this.adTimeoutPassed()
//                 ? (console.log("Adsense: calling adBreak (displaying an ad)"),
//                   void this.adBreak({
//                     type: "start",
//                     beforeAd: function () {
//                       console.log("Adsense: beforeAd"), (t.running = !0);
//                     },
//                     afterAd: function () {
//                       (t.running = !1),
//                         (t.lastAdTime = new Date().getTime()),
...
//                     },
//                   }))
//                 : (console.log("Pacing violation"), void (e && e()))
//               : void this.displayRetry.retry(
//                   function () {
//                     t.display(e);
//                   },
//                   e,
//                   "Waiting for adsense to become ready"
//                 );
//           },
//           adTimeoutPassed: function () {
//             return this.testMode()
...
//             switch ((console.log("Got video ad settings"), e.ad_provider)) {
//               case "ad_sense":
//                 (this.strategy = i),
//                   this.strategy.bootstratp(
...
//             if (!this.strategy) {
//               var t = this;
//               return void this.displayRetry.retry(
//                 function () {
//                   t.display(e);
//                 },
//                 e,
//                 "Waiting for ad strategy"
//               );
//             }
//             this.strategy.display(e), this.displayRetry.reset();
//           },
//         };
//       }
//     ),
...
//         var t,
//           n = e("utils/constants"),
//           i = (e("sdk/api"), e("logger")),
//           r = e("runtime"),
//           a = e("utils/jquery-amd");
//         return {
//           updateAvatar: function (e, o) {
//             var s = r.getOAuthToken();
//             if (!s) return i.log("Player must be logged in to update avatar.");
//             i.addCall();
//             var l = new FormData();
//             e.name && "blob" != e.name
//               ? l.append("profile_picture[attachment]", e)
//               : "image/jpeg" == e.type
//               ? l.append("profile_picture[attachment]", e, "image.jpg")
//               : l.append("profile_picture[attachment]", e, "image.png");
...
//                 this.browser && -1 != this.browser.name.search("Safari")
//                   ? o.redirectToOauthLogin(t)
//                   : o.login(t, n(e), n(e));
//               },
//               safariFixRegister: function (e, t) {
//                 this.browser && -1 != this.browser.name.search("Safari")
//                   ? o.redirectToOauthRegistration(t)
//                   : o.register(t, n(e), n(e));
//               },
...
//                 return t
//                   ? (h.addCall(), o.fetchLoginStatus(e, e, i))
//                   : r.status && r.authResponse
//                   ? n(e).call({}, r)
//                   : void o.fetchLoginStatus(e, e, i);
//               },
//               ui: function (e, t, n) {
//                 d.open(e, t, n), h.addCall();
//               },
...
//               ads: A,
//               init: function (e) {
//                 if (e.forceInit) a.reset(), f.reset(), p.reset();
//                 else if (a.initialized()) return;
//                 if ((a.init(e), a.initialized()))
//                   try {
//                     c.xdHandler(), f.update(), p.init(this), y.init(), m.init();
//                   } catch (t) {
//                     h.log("Error in id " + t);
//                   }
