function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: 715 , y: 572};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);

        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED, FONT_SIZE_CREDITS + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLink = new createjs.Text("www.codethislab.com", FONT_SIZE_CREDITS + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
